...
;(function($,global) {
     ...
     */
      var ContoBase = function(selectorClasse, selectorCodificaInterna, selectorCodiceConto, selectorDescrizioneConto, automaticSelectConto, contoCodiceClasseSelector, contoSelector) {
        // Campi della pagina
    ...
    function apriModale() {
        ...
        if($("#HIDDEN_ambitoContoINV").val() === $("#HIDDEN_ambitoConto").val()){
        	$("#divContoINV").slideDown();
        }else{
        	$("#divContoINV").slideUp();
        }
    ...
    function inizializza(selectorClasse, selectorCodificaInterna, selectorCodiceConto, selectorDescrizioneConto, selectorPulsante, automaticSelectConto, codiceClasseDaPreImpostare) {
        ...
        conto= new ContoBase(selectorClasse, selectorCodificaInterna, selectorCodiceConto, selectorDescrizioneConto, automaticSelectConto, contoCodiceClasseSelector, contoSelector);
