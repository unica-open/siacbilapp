...
var TipoBene = function($,global) {
	...
	function inizializzaCompilazioniGuidateConti(){		
		arrayConti.forEach(function(value){
			var obj = ContoBase.inizializza('', '', '#codiceConto' + value, '#descrizioneConto' + value, '#pulsanteCompilazioneGuidataConto' + value, undefined, undefined, [6,7]);
			//selectorClasse, selectorCodificaInterna, selectorCodiceConto, selectorDescrizioneConto, selectorPulsante, automaticSelectConto, codiceClasseDaPreImpostare, livelliAccettabili
