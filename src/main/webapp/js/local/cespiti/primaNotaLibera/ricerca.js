...
!function($, global) {
    ...
    function ricaricaCausaliPerEvento(){
        ...
        var ambitoContoCausale = $("#ambitoContoCausale").val();
        var ambito = $("#ambito").val();
        
        var objToSend = {"evento.uid": evento, "ambito": ambitoContoCausale};
        // Chiamata AJAX
    ...
    $(function () {
        ...
        Cespite.inizializza("#codiceCespite", '#descrizioneCespite', "#pulsanteCompilazioneGuidataCespite");
    });
