...
var RateiRisconti = (function($) {
    ...
    function ottieniDatiFinanziari(e) {
        ...
        return $.post('gestioneRateiRiscontiPrimaNotaIntegrataDocumentoGSA_ottieniDatiFinanziari.do', obj)
        .then(function(data) {
    ...
    function caricaElencoScritture(e) {
         ...
         $.postJSON("gestioneRateiRiscontiPrimaNotaIntegrataDocumentoGSA_ottieniListaConti.do", {uidMovimentoEPPerScritture: uidMovimentoEP})
         .then(function(data) {
  ...
  function inserimentoRateo(e){
   ...
   function impostaRateoDopoAggiornamento(e){
	   ...
	   $('#elencoScrittureQuota').slideUp();
	   return $.postJSON('gestioneRateiRiscontiPrimaNotaIntegrataDocumentoGSA_impostaRateoDopoAggiornamento.do',obj).then(function(data){
