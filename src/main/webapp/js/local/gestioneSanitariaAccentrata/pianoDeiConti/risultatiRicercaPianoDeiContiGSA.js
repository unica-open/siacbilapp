...
!function($, global) {
    ...
    function ricercaPianoDeiConti() {
        ...
        // Effettuo la ricerca
        $.postJSON("ricercaPianoDeiContiGSA_effettuaRicerca.do", obj, function(data) {
            // Se ho errori, esco
                ...
                {   aTargets: [6],
                    mData: function(source) {
                        return "<div class='btn-group'>"
                                ...
                                +         "<li><a href='ricercaPianoDeiContiGSA_consulta.do?uidConto="+source.uid+"'>consulta</a></li>"
                                +     "</ul>"
                                + "</div>";
                    },
        ...
        var nuovaIntestazione = "<td>"+ conto.pianoDeiConti.classePiano.descrizione +"</td>"+
                                ...
                                "<td class ='tab_Right'>" +
                                    "<div class='btn-group'>" +
                                      ...
                                      "<ul class='dropdown-menu pull-right'>" +
                                            "<li><a href='ricercaPianoDeiContiGSA_consulta.do?uidConto="+conto.uid+"'>consulta</a></li>";
        if(isGestioneConsentita && conto.livello !== 0){
                        nuovaIntestazione +="<li><a href='ricercaPianoDeiContiGSA_aggiorna.do?uidConto="+conto.uid+"'>aggiorna</a></li>";
        }

        if(isGestioneConsentita && !conto.contoFoglia && conto.attivo && conto.livello <= conto.pianoDeiConti.classePiano.livelloDiLegge){
                        nuovaIntestazione +="<li><a href='ricercaPianoDeiContiGSA_inserisciFiglio.do?uidConto="+conto.uid+"'>inserisci figlio</a></li>";
