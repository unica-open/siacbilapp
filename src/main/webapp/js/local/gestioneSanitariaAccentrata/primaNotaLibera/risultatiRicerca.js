...
!function($, global) {
    ...
    function impostaTabellaTipoOperazioniCassa() {
        ...
        var opts = {
            bServerSide: true,
            sServerMethod: "POST",
            sAjaxSource : "risultatiRicercaPrimaNotaLiberaGSAAjax.do",
            bPaginate: true,
            bLengthChange: false,
            iDisplayLength: 10,
            bSort: false,
    ...
    function apriModaleDettagli (e) {
        ...
        $.postJSON("dettaglioMovimentiPrimaNotaLiberaGSAAction_caricaMovimenti.do", {"primaNotaLibera.uid": primaNotaLibera.uid}, function(data) {
