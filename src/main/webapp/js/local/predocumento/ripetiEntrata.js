...
;(function($) {
    ...
    var doLoadCausale = $('#doLoadCausale').val() === 'true';
    ...
    function init() {
        ...
        causale.change(PreDocumento.impostaDatiCausaleEntrata);
