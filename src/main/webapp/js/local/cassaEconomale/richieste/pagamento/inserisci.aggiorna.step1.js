...
!function($) {
    ...
    $(function() {
    	  var spanDescrizione = $("#descrizioneSoggetto");
          var campoCodiceSoggetto = $("#codiceSoggettoRichiestaEconomale");
     ...
     // Carica il dettaglio del soggetto e apre gli accordion
        ...
        // Inizializzazione della gestione del 
        Soggetto.inizializza("#codiceSoggettoRichiestaEconomale", "#HIDDEN_codiceFiscaleSoggetto", "#HIDDEN_denominazioneSoggetto", "#descrizioneSoggetto", "#pulsanteAperturaCompilazioneGuidataSoggetto", "","#HIDDEN_soggettoUid");
