...
//            $("#contoCorrenteMovimento").val(movimento && movimento.contoCorrente || "");
            modalitaPagamentoSoggetto.val(data.rendicontoRichiesta.movimento.modalitaPagamentoSoggetto && data.rendicontoRichiesta.movimento.modalitaPagamentoSoggetto.uid || "");
        }).always(function() {
...
//            $("#bicMovimento").val(data.rendicontoRichiesta.movimento.bic);
    ...
    /**
     * Gestione della visione degli importi per l'economo.
     */
    function gestioneImportiEconomo() {
        var dataMovimento = $("#dataMovimentoMovimento").val();
        var modalitaPagamentoCassa = $("#modalitaPagamentoCassaMovimento").val();
        var method = dataMovimento && modalitaPagamentoCassa ? "slideDown" : "slideUp";
        // Mostro o nascondo i div
        $("div[data-importo-economo]", "#wellDatiEconomo")[method]();
    }
    ...
    $(function() {
        ...
        $("#annoMovimentoMovimentoGestione, #numeroMovimentoGestione, #numeroSubMovimentoGestione").change(valutaCaricamentoImpegno)
            ...
            .first()
                .change();
        $("#dataMovimentoMovimento, #modalitaPagamentoCassaMovimento").change(gestioneImportiEconomo);
