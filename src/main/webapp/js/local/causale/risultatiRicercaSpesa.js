...
var Causale = (function ($) {
            ...
            "aoColumnDefs" : [
                ...
                {"aTargets" : [ 2 ], "mData" : "movimentoGestione"},
                {
                    ...
                    "mData" : function(source) {
                        return source.modalitaPagamentoSoggetto ? "<a rel='popover' href='#'>" + source.soggetto + "</a>" : source.soggetto;
                    },
                    "fnCreatedCell" : function (nTd, sData, oData) {
                        // Settings del popover
                        var settings = {
                            "content" : oData.modalitaPagamentoSoggetto,
    ...
    exports.visualizzaTabellaCausali = function() {
        var options = {
            ...
            "sAjaxSource" : "risultatiRicercaCausaleSpesaAjax.do",
            ...
            "aoColumnDefs" : [
                ...
                {"aTargets" : [ 1 ], "mData" : "tipoCausale"},
                {
                    "aTargets" : [ 2 ],
                    "mData" : function(source) {
                        return "<a rel='popover' href='#'>" + source.statoOperativoCausaleDesc + "</a>";
                    },
                    "fnCreatedCell" : function (nTd, sData, oData) {
                        // Settings del popover
                        var settings = {
                ...
                {"aTargets" : [ 7 ], "mData" : "sediSecondarie"},
