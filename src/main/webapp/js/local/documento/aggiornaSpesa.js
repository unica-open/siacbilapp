...
var Documento = (function(global, $) {
     ...
     */
    function gestioneSubmitPerCheckbox(e) {
        var res = _oldPreSubmit(e);
        if(e.currentTarget.id !== 'formAggiornamentoDatiDocumento') {
            return res;
        }
        var checkbox = $("#beneficiarioMultiplo");
