    ...
    function popolaTabella (lista) {
        var options = {
            ...
            oLanguage: {
                ...
                sZeroRecords: "Non sono presenti documenti collegati associati",
                oPaginate: {
                    sFirst: "inizio",
                    sLast: "fine",
                    sNext: "succ.",
        ...
        $("#tabellaDocumentiCollegatiDocumento").dataTable(options);
    }

    exports.ottieniLista = function() {
        $.postJSON(
            "aggiornamentoDocumentoEntrata_ottieniListaDocumentiCollegati.do",
            function(data) {
                popolaTabella(data.listaDocumentoSpesa);
            }
        );
    };

    doc.DocumentiCollegati = exports;
    return doc;
}(jQuery, Documento || {}));

$(function() {
    Documento.DocumentiCollegati.ottieniLista();
});