...
;(function($, w, doc) {
    ...
    function ottieniQuoteIva() {
        ...
        $.postJSON("aggiornamentoDocumentoEntrata_ottieniQuoteRilevantiIva.do", function(data) {
            ...
            aoColumnDefs: [
                ...
                {aTargets: [7], mData: function(source) {
                    ...
                    $("a", nTd).substituteHandler("click", function(e) {
                        var url = "aggiornamentoDocumentoEntrata_redirezione$DocumentoIvaEntrata_quota.do";
     ...
     *
     * @returns <code>true</code> se il documento e' completo; <code>false</code> altrimenti
     */
