...
!function () {
     ...
     * @param dpc (Object) l'oggetto contenuto nella tabella
     */
    ...
    function effettuaAttivazioneGENPCC(td, uid) {
        ...
        $.postJSON("risultatiRicercaDocumentoSpesa_attivaRegistrazioniContabili.do", {uidDaAggiornare: uid})
        .then(function(data) {
    ...
    function caricaTabellaOrdini(uid, alertToUse) {
        return $.postJSON("risultatiRicercaDocumentoSpesa_ottieniListaOrdine.do", {uidDaConsultare: uid})
        .then(function(data) {
    ...
    function dettaglioQuote(td, e, uid) {
        ...
        $.postJSON("risultatiRicercaDocumentoSpesaDettaglioQuote.do", {uidDaConsultare : uid})
        .then(function(data) {
    ...
    function eliminaOrdine(e, ordine, nTd) {
        ...
        $.postJSON("risultatiRicercaDocumentoSpesa_eliminaOrdine.do", obj)
        .then(function(data) {
            // Se ho errori esco
    ...
    function popolaTabellaQuote() {
        var isOverlay = false;
        var table = $("#tabella_modaleDettaglioQuote").overlay({rebind: true, loader: true, usePosition: true});
        var options = {
            bServerSide: true,
    ...
    function salvaInserimentoOrdine() {
        ...
        $.postJSON("risultatiRicercaDocumentoSpesa_" + op + "Ordine.do", obj)
        .then(function(data) {
            // Se ho errori esco
            if(impostaDatiNegliAlert(data.errori, $("#ERRORI_MODALE_ORDINI"))) {
                return;
