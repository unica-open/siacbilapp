...
;(function($, w, doc) {
    ...
    function ottieniQuoteIva() {
        ...
        $.postJSON("aggiornamentoTestataDocumentoEntrata_ottieniQuoteRilevantiIva.do", function(data) {
                    ...
                    },
                    {
                        ...
                        fnCreatedCell: function(nTd, sData, oData) {
                            $("a", nTd).substituteHandler("click", function(e) {
                                var url = "aggiornamentoTestataDocumentoEntrata_redirezione$DocumentoIvaEntrata_quota.do";
