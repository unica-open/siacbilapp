...
!function(global, $) {
	...
	function apriModalePrevisioneImpegnatoAccertato(e){
		...
		$.post('risultatiRicercaCapEGPrevisioneImpegnatoAccertato_caricaTabellaImporti.do', obj)
        .then(function(data) {
	...
	function aggiornaPrevisioneImpegnatoAccertato(){
		...
		$.postJSON("risultatiRicercaCapEGPrevisioneImpegnatoAccertato_aggiorna.do", qualify(previsioneImpegnatoAccertato, "previsioneImpegnatoAccertato"))
			.then(function(data){
	...
	$(document).ready(
	    function () {
	        ...
	        RisultatiRicerca.wrapperDataTable("risultatiRicercaCapEntrataGestionePrevisioneAccertatoAjax.do", "risultatiRicercaCapUscitaGestione", startPos);
