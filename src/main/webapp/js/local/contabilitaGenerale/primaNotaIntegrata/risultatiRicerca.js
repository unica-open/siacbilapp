...
*/
var RisultatiRicercaPrimeNote = (function($) {
    var exports = {};
    "use strict";
    ...
    /**
     * Impostazione della tabella delle prime note.
     */
    exports.impostaTabellaPrimaNota = function() {
        ...
        var opts = {
            bServerSide: true,
            sServerMethod: "POST",
            sAjaxSource : "risultatiRicercaPrimaNotaIntegrataFINAjax.do",
            bPaginate: true,
            bLengthChange: false,
            iDisplayLength: 10,
            bSort: false,
            ...
            fnPreDrawCallback: function () {
                ...
                $(tableId + "_processing").parent("div")
                    .show();
                //$('#formPrimaNotaLibera').overlay('show');
            },
                ...
                {aTargets: [8], mData: "azioni", fnCreatedCell: function(nTd, sData, oData) {
                    $(nTd).addClass("tab_Right")
                    	...
                    	.find("a.collegaPrimaNota")
                    		...
                    		.end()
                    	.find("a.ratei")
                    		.click([oData], RateiRisconti.inserimentoRateo)
                    		.end()
                    	.find("a.rateiAggiornamento")
                    		.click([oData], RateiRisconti.aggiornamentoRateo)
                    		.end()
                    	.find("a.gestioneRisconti")
                    		.click([oData], RateiRisconti.gestioneRisconti)
		            		.end();
                }}
            ]
        };
    ...
    /**
     * Aggiunta di una prima nota all'elenco delle prime note collegate
     */
    ...
    function impostaTabellaPrimeNoteCollegate(list) {
        ...
        var opts = {
            ...
            aoColumnDefs: [
                {aTargets: [0], mData: function(source){
                	return source.tipoCausale != null ? source.tipoCausale.descrizione : "";
                }},
                {aTargets: [1], mData: function(source){
                	return source.bilancio != null ? source.bilancio.anno : "";
                }},
                {aTargets: [2], mData: function(source){
                	return source.numeroRegistrazioneLibroGiornale != null ? source.numeroRegistrazioneLibroGiornale : "";
                }},
                {aTargets: [3], mData: function(source){
    ...
    /**
     * Eliminazione del collegamento tra due prime note.
     *
...
$(function() {
    ...
    $("#pulsanteCollegamentoPrimeNote").click(RisultatiRicercaPrimeNote.aperturaCollapseCollegamentoPrimaNota);
    $("#pulsanteSalvaCollegamento").click(RisultatiRicercaPrimeNote.collegaPrimaNota);
