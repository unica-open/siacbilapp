...
//            }
    ...
    function caricaElencoScritture() {
         ...
         $.postJSON("aggiornaContoPrimaNotaIntegrataFIN_ottieniListaConti.do", {})
         .then(function(data) {
             if(impostaDatiNegliAlert(data.errori, $('#ERRORI'))) {
...
//        alertInformazioni.slideUp();
        ...
        $.postJSON("aggiornaContoPrimaNotaIntegrataFIN_aggiornaConto.do", obj)
        .then(function(data) {
    ...
    function eliminazioneConto(index) {
        ...
        $.postJSON("aggiornaContoPrimaNotaIntegrataFIN_eliminaConto.do", {indiceConto: index})
        .then(function(data) {
            if(impostaDatiNegliAlert(data.errori, $('#ERRORI'))) {
    ...
    function inserisciConto() {
        ...
        $.postJSON("aggiornaContoPrimaNotaIntegrataFIN_inserisciConto.do", obj)
        .then(function(data) {
    ...
    function submitForm(e) {
        ...
        $.postJSON('aggiornaPrimaNotaIntegrataFIN_aggiorna.do', obj)
        .then(function(data) {
            ...
            loc[loc.length - 1] = 'aggiornaPrimaNotaIntegrataFIN_aggiornaSuccess.do';
