...
;(function($,global) {
     ...
     * @param livelliAccettabili       (Number[]) i possibili livelli accettabili
     */
      var ContoBase = function(selectorClasse, selectorCodificaInterna, selectorCodiceConto, selectorDescrizioneConto, automaticSelectConto, contoCodiceClasseSelector, contoSelector, livelliAccettabili) {
        // Campi della pagina
        ...
        this.codiceClasseImpostare = contoCodiceClasseSelector;
        this.contoSelector = contoSelector || "";
        this.$hiddenCodiceSelector = $("#HIDDEN_selectorConto");
        
        // Campi di filtro
        this.livelliAccettabili = livelliAccettabili === undefined || livelliAccettabili === null || livelliAccettabili.length === 0 ? undefined : livelliAccettabili;
    };
    var exports = {};
    
    exports.inizializza = inizializza;
    exports.destroy = destroy;
    global.ContoBase = exports;
        
    ContoBase.prototype.constructor = ContoBase;
    ContoBase.prototype.ricercaPianoDeiConti = ricercaPianoDeiConti;
    ContoBase.prototype.cleanAll  =  cleanAll;
    ContoBase.prototype.resetAll = resetAll;
    ContoBase.prototype.apriModale = apriModale;
    ContoBase.prototype.svuotaPDC = svuotaPDC;
    ContoBase.prototype.abilitaDisabilitaPerClasse = abilitaDisabilitaPerClasse;
    ContoBase.prototype.gestisciMacroaggregato = gestisciMacroaggregato;
    ContoBase.prototype.gestisciTipologia = gestisciTipologia;
    ContoBase.prototype.gestisciCategoria = gestisciCategoria;
    ContoBase.prototype.gestioneEntrateSpese = gestioneEntrateSpese;
    ContoBase.prototype.caricaTipologia = caricaTipologia;
    ContoBase.prototype.caricaCategoria = caricaCategoria;
    ContoBase.prototype.caricaMacroaggregato = caricaMacroaggregato;
    ContoBase.prototype.gestisciPDC = gestisciPDC;
    ContoBase.prototype.caricaPianoDeiConti = caricaPianoDeiConti;
    ContoBase.prototype.init = init;
    ContoBase.prototype.impostaConto = impostaConto;
    ...
    function impostaTabellaRisultati() {
        ...
        var opts = $.extend({},beseOptsDataTable,optsConto);
    ...
    function ricercaPianoDeiConti() {
        ...
        var livelloSelezionato = this.$livelloPianoDeiContiRicerca.val();
        
        //SIAC-6431
        if (this.livelliAccettabili !== undefined && livelloSelezionato !== '' && this.livelliAccettabili.indexOf(+livelloSelezionato) === -1){
		    impostaDatiNegliAlert(['COR_ERR_0004 - Formato non valido, i valori accettabili per il Livello sono solo ' + this.livelliAccettabili.join(',')+' dei conti foglia'], alertErroriModale)
    ...
    function preselezionaClasseSeNecessario($select, codiceClasse){
    	if(!codiceClasse){
    		return;
    	}
    	return $select.find('option[data-codice="' + codiceClasse + '"]').val();
    }
    
    function apriModale() {
        this.init();
        this.$fieldsetRicerca.find(":input").not("[data-maintain]").val("");
        var uidDaPreselezionare = preselezionaClasseSeNecessario(this.$classeModale, this.codiceClasseImpostare) || this.$classe.val();
        this.isClasseStartEmpty = (this.$classeModale.val() === "" || this.$classeModale.val() === "0") && !uidDaPreselezionare;
        //Popolo campi modale
        if(this.automaticSelectConto) {
            this.$classeModale.val(uidDaPreselezionare);
        ...
        this.$hiddenCodiceSelector.val(this.contoSelector);
    ...
    function abilitaDisabilitaPerClasse() {
    ...
    function gestisciMacroaggregato() {
    ...
    function cleanGestioneEntrataSpesePDC(){
        $("#HIDDEN_ElementoPianoDeiContiUid").val("");
        $("#HIDDEN_ElementoPianoDeiContiStringa").val("");
        $("#SPAN_ElementoPianoDeiConti").html("Nessun P.d.C. finanziario selezionato");
        impostaZTree("treePDC", zTreeSettingsBase, null);
     ...
     */
     function caricaPianoDeiConti(obj) {
        ...
        .then(function (data) {
            ...
            $("treePDC_1_check").attr("disabled",true);
    ...
    function destroy(){
        ...
        instance.$classeModale.off("change");
        instance.$titoloSpesaModale.off("change");
        instance.$macroaggregatoModale.off("change");
        instance.$titoloEntrataModale.off("change");
        instance.$tipologiaTitoloModale.off("change");
        instance.$categoriaTipologiaTitoloModale.off("change");
        instance.$bottoneCercaModaleRicercaPDCModale.off("click");
        instance.$pulsanteConfermaModaleRicercaConto.off("click");
           
    	instance = undefined;
    }
    

    function inizializza(selectorClasse, selectorCodificaInterna, selectorCodiceConto, selectorDescrizioneConto, selectorPulsante, automaticSelectConto, codiceClasseDaPreImpostare, livelliAccettabili) {
        var $pulsante = $(selectorPulsante);
        var conto;
        var contoSelector = $pulsante.data('selector-conto');
        var contoCodiceClasseSelector = $pulsante.data('selector-classe'); 
        conto= new ContoBase(selectorClasse, selectorCodificaInterna, selectorCodiceConto, selectorDescrizioneConto, automaticSelectConto, contoCodiceClasseSelector, contoSelector, livelliAccettabili);
    	$pulsante.click(conto.apriModale.bind(conto));
        instance = conto;
        return instance;
    }
