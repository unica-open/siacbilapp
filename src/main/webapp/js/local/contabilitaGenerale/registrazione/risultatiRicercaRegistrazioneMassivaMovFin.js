...
!function($) {
    ...
    function visualizzaTabelleRicheste() {
        var options = {
            bServerSide: true,
            sAjaxSource: 'risultatiRicercaRegistrazioneMassivaMovFinFINAjax.do',
            sServerMethod: 'POST',
            bPaginate: true,
            bLengthChange: false,
            bDestroy: true,
            ...
            aoColumnDefs : [
                ...
                {aTargets: [4], mData: 'stringaContoIniziale'},
                {aTargets: [5], mData: 'stringaContoAggiornato'}
            ]
        };
    ...
    function effettuaRegistrazioneMassiva(){
        ...
        document.location = "risultatiRicercaRegistrazioneMassivaMovFinFIN_registraTutto.do";
    }
