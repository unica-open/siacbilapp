...
!function($, global) {
    ...
    function impostaTabellaTipoOperazioniCassa() {
        ...
        var opts = {
            bServerSide: true,
            sServerMethod: "POST",
            sAjaxSource : "risultatiRicercaCausaleEPFINAjax.do",
            bPaginate: true,
            bLengthChange: false,
            iDisplayLength: 10,
            bSort: false,
    ...
    function annullamentoCausaleEP(e) {
        ...
        $("#modaleAnnullamentoPulsanteSalvataggio").substituteHandler("click", function() {
            ...
            document.location = "risultatiRicercaCausaleEP_annulla.do?causaleEP.uid=" + causale.uid;
            document.location = href;
        });
    ...
    function eliminazioneCausaleEP(e) {
        ...
        $("#modaleEliminazionePulsanteSalvataggio").substituteHandler("click", function() {
            ...
            document.location = "risultatiRicercaCausaleEP_elimina.do?causaleEP.uid=" + causale.uid;
            document.location = href;
        });
