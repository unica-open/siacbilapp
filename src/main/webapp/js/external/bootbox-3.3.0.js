...
var bootbox = window.bootbox || (function(document, $) {
    ...
    that.dialog = function(str, handlers, options) {
        ...
        // FORK
        var parts = ["<div role='dialog' class='bootbox modal' tabindex='-1' aria-hidden='false'>"];
        // FORK
        ...
        if (options['header']) {
            ...
            if (typeof options['headerCloseButton'] == 'undefined' || options['headerCloseButton']) {
                // FORK
                closeButton = "<button class='bootbox-close-button close' type='button'>&times;</button>";
            }
        ...
        // FORK
        div.find(".modal-body").html("<div class='bootbox-body'>" + str + "</div>");
        ...
        div.on('click', 'a.close, button.close', function(e) {
            e.preventDefault();
            onCancel('close');
        });
