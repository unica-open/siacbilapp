...
<body>
		...
		<div class="row-fluid">
			<div class="span12 contentPage">
				...
				<s:form cssClass="form-horizontal" action="%{urlStep1}" novalidate="novalidate" id="formRichiestaEconomale">
					...
					<s:hidden name="isAggiornamento" id="isAggiornamento" id="HIDDEN_isAggiornamento"/>
					...
					<div class="step-content">
						<div id="step1" class="step-pane active">
							<fieldset class="form-horizontal">
								...
								<s:include value="/jsp/cassaEconomale/richieste/include/datiCreditore.jsp">
				...
				<s:if test="%{!isAggiornamento}">
					...
					<s:include value="/jsp/cassaEconomale/richieste/pagamento/inserimentoAggiornamento/modaleGiustificativo.jsp" />
				</s:if>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/cassaEconomale/richieste/pagamento/inserisci.aggiorna.step1.js"></script>
