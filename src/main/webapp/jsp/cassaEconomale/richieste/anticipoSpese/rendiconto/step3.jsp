...
<body>
				...
				<s:form cssClass="form-horizontal" action="%{urlStep3}" novalidate="novalidate" id="formRichiestaEconomale">
					...
					<div class="step-content">
						<div id="step3" class="step-pane active">
							<s:include value="/jsp/cassaEconomale/richieste/anticipoSpese/rendiconto/fieldsetRiassuntivo.jsp" />
						</div>
					</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/cassaEconomale/richieste/anticipoSpese/rendiconto.step3.js"></script>
