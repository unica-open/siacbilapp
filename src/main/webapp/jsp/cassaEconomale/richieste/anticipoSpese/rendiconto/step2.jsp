...
<body>
					...
					<div class="step-content">
						<div id="step2" class="step-pane active">
							<fieldset class="form-horizontal">
								...
								<div class="clear"></div>
								<br/>
								<s:include value="/jsp/cassaEconomale/richieste/include/fieldsetMovimentoStep2Rendiconto.jsp" />
							</fieldset>
						</div>
					</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/cassaEconomale/richieste/anticipoSpese/rendiconto.step2.js"></script>
