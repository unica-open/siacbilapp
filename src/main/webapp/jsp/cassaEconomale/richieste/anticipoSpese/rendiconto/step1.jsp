...
<body>
		...
		<div class="row-fluid">
			<div class="span12 contentPage">
				...
				<s:form cssClass="form-horizontal" action="%{urlStep1}" novalidate="novalidate" id="formRichiestaEconomale">
					...
					<h3>Anticipo spese - Rendiconto</h3>
						...
						<div id="step1" class="step-pane active">
							<fieldset class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<s:textfield id="descrizioneDellaRichiestaRichiestaEconomale" name="rendicontoRichiesta.richiestaEconomale.descrizioneDellaRichiesta" cssClass="span6" required="true" />
									</div>
								</div>
								<div class="control-group">
	...
	<script type="text/javascript" src="/siacbilapp/js/local/cassaEconomale/richieste/anticipoSpese/rendiconto.step1.js"></script>
