					...
					<div class="step-content">
						<div id="step1" class="step-pane active">
							<fieldset class="form-horizontal">
								...
								<div class="control-group">
									<label class="control-label" for="importoRichiestaEconomale">Importo anticipo *</label>
									<div class="controls">
										<s:textfield id="importoRichiestaEconomale" name="richiestaEconomale.importo" cssClass="span6 soloNumeri decimale" required="true" />
									</div>
								</div>
								<div class="control-group">
