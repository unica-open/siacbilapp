...
<body>
				...
				<s:form cssClass="form-horizontal" action="%{urlStep3}" novalidate="novalidate" id="formRichiestaEconomale">
					...
					<div class="step-content">
						<div id="step3" class="step-pane active">
							<s:include value="/jsp/cassaEconomale/richieste/rimborsoSpese/fieldsetRiassuntivo.jsp" />
						</div>
					</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/cassaEconomale/richieste/rimborsoSpese/inserisci.aggiorna.step3.js"></script>
