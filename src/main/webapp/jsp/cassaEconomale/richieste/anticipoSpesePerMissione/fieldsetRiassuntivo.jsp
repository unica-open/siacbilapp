		...
		<tbody>
			<s:iterator value="richiestaEconomale.giustificativi" var="giu">
				<tr>
					...
					<td><s:property value="#giu.valuta.descrizione" /></td>
					<td><s:property value="#giu.cambio" /></td>
					<td class="tab_Right"><s:property value="#giu.importoGiustificativoInValuta" /></td>
