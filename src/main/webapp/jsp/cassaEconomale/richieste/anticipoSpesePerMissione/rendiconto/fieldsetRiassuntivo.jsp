	...
	<div class="boxOrSpan2 margin-medium">
		<div class="boxOrInLeft">
			...
			<ul class="htmlelt">
				...
				<li>
					<dfn>Numero</dfn>
					<dl><s:property value="rendicontoRichiesta.richiestaEconomale.impegno.numero"/>&nbsp;</dl>
				</li>
				<li>
					<dfn>SubImpegno</dfn>
					<dl><s:property value="rendicontoRichiesta.richiestaEconomale.subImpegno.numero"/>&nbsp;</dl>
				</li>
				<li>
					<dfn>Descrizione</dfn>
		...
		<div class="boxOrInRight">
			...
			<ul class="htmlelt">
				...
				<li>
					<dfn>Descrizione</dfn>
					<dl><s:property value="rendicontoRichiesta.richiestaEconomale.datiTrasfertaMissione.motivo"/>&nbsp;</dl>
				</li>
				<li>
					<dfn>Note</dfn>
