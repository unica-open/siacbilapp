...
<body>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/cassaEconomale/richieste/risultatiRicerca.js"></script>
	<script type="text/javascript" src="/siacbilapp/js/local/cassaEconomale/richieste/<s:property value="pathTipoRichiestaEconomale" />/risultatiRicerca.js"></script>
