...
<div aria-hidden="true" aria-labelledby="labelModaleRestituzioneAltroUfficio" role="dialog" tabindex="-1" class="modal hide fade" id="modaleRestituzioneAltroUfficio">
	<div class="modal-header" id="labelModaleRestituzioneAltroUfficio">
		<button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
		<h4 class="nostep-pane">Restituzione altro ufficio</h4>
	</div>
	...
	<div class="modal-footer">
		...
		<button type="button" class="btn btn-primary" id="pulsanteConfermaModaleRestituzioneAltroUfficio">conferma</button>
	</div>
</div>