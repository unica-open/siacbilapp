...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form action="effettuaRicercaCausaleEntrata" id="formRicercaCausaleEntrata" novalidate="novalidate">
					<s:include value="/jsp/include/messaggi.jsp" />
					<h3>Ricerca causale incasso</h3>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/causale/ricercaCausaleEntrata.js"></script>
