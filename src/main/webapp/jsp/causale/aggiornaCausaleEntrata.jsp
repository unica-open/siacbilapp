...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="aggiornamentoCausaleEntrata" id="formAggiornamentoCausaleEntrata" novalidate="novalidate" >
	...
	<script type="text/javascript" src="/siacbilapp/js/local/causale/aggiornaCausaleEntrata.js"></script>
</body>
</html>