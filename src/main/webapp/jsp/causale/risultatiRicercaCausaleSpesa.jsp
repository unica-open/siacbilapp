...
<body>
			...
			<div class="span12 ">
				<div class="contentPage">
					...
					<form method="post" action="#">
						<h3>Risultato ricerca causale pagamento</h3>	
						...
						<h4><span id="id_num_result" class="num_result"></span></h4>
							...
							<thead>
								<tr>
									...
									<th scope="col">Sedi secondarie</th>				
						...
						<div id="msgAnnulla" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="msgAnnullaLabel" aria-hidden="true">
							...
							<div class="modal-footer">
								...
								<button class="btn btn-primary" formmethod="post" type="submit" formaction="risultatiRicercaCausaleSpesaAnnulla.do">conferma</button>
							</div>
	...
	<s:include value="/jsp/causale/consultaCausaleSpesa_modale.jsp" />
	<s:include value="/jsp/include/footer.jsp" />	
	<s:include value="/jsp/include/javascript.jsp" />
	<script type="text/javascript" src="/siacbilapp/js/local/causale/risultatiRicercaSpesa.js"></script>
</body>
</html>