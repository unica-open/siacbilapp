...
<body>
	...
	<script type="text/javascript" src="${jspath}cespiti/ricercaCespite.js"></script>
	<script type="text/javascript" src="${jspath}cespiti/ricercaConto.js"></script>
	<script type="text/javascript" src="${jspath}cespiti/primaNotaLibera/ricerca.js"></script>
</body>
</html>