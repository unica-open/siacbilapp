	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
					...
					<div class="step-content">
						<div class="step-pane active" id="step1">
							<fieldset class="form-horizontal" id="#fieldsetStep2">
									...
									<div class="accordion-group">
										...
										<div class="accordion-body collapse" id="divPrimeNoteCollegate">
											<div class="accordion-inner">
												...
												<s:include value="/jsp/cespiti/primaNotaLibera/include/collapseCollegamentoPrimaNota.jsp" />
											</div>
										</div>
									</div>
								</div>
								...
								<s:include value="/jsp/cespiti/primaNotaLibera/include/collapseDatiStruttura.jsp" />
							</fieldset>
						</div>
					</div>
				...
				<s:include value="/jsp/cespiti/primaNotaLibera/include/modaleEliminazioneConto.jsp" />
				<s:include value="/jsp/cespiti/primaNotaLibera/include/modaleAggiornaConto.jsp" />
				<s:include value="/jsp/cespiti/include/modaleRicercaConto.jsp" />
				<s:include value="/jsp/cespiti/include/modaleRicercaPrimaNota.jsp" />
			</div>
		</div>
	</div>	
