		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					<s:form id="formInserisciTipoBene" cssClass="form-horizontal" novalidate="novalidate" action="aggiornaTipoBene_salva">
						<s:hidden name="ambito" id="ambito" />
						<s:hidden name="ambitoCausaleInventario" id="ambitoCausaleInventario" />
						<s:hidden name="tipoBeneCespite.uid"/>
						<s:hidden name="tipoBeneCespite.annullato"/>
						<h3 id="titolo">Aggiorna anagrafica tipo bene </h3>
							...
							<div class="step-pane active" id="step1">
								<fieldset class="form-horizontal">
									<div class="control-group">
										...
										<div class="controls">
											<s:textfield id="codiceCategoriaCespiti" name="tipoBeneCespite.codice" cssClass="span6" placeholder="codice" required="true" disabled="true" maxlength="500"/>
											<s:hidden name="tipoBeneCespite.codice"/>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="control-group"> 
											...
											<div class="controls">
												<s:select list="listaCausaleEP" id="uidCausaleEPAmmortamento" name="tipoBeneCespite.causaleAmmortamento.uid"
													cssClass="span6" headerKey="" headerValue="" listKey="uid" listValue="%{codice + ' - ' + descrizione}" data-causale-EP-uid="%{uidOldCausaleAmmortamento}" />
											</div>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<span id="descrizioneContoMinusValenza"></span>
											<span class="radio guidata">
									...
									<div id = "incrementoGestione">
										<div class="control-group">
											<label class="control-label" for="codiceConto">Conto di incremento valore</label>
											<div class="controls">
										...
										<div class="control-group"> 
											...
											<div class="controls">
												<s:select list="listaCausaleEP" id="uidCausaleEPIncremento" name="tipoBeneCespite.causaleIncremento.uid"
													cssClass="span6" headerKey="" headerValue="" listKey="uid" listValue="%{codice + ' - ' + descrizione}" data-causale-EP-uid="%{uidOldCausaleIncremento}"/>
											</div>
										</div>
									</div>
									<div id = "decrementoGestione">
										<div class="control-group">
											...
											<div class="controls">
												...
												<span id="descrizioneContoDecremento"></span>
												<span class="radio guidata">
										...
										<div class="control-group"> 
											...
											<div class="controls">
												<s:select list="listaCausaleEP" id="uidCausaleEPDecremento" name="tipoBeneCespite.causaleDecremento.uid"
													cssClass="span6" headerKey="" headerValue="" listKey="uid" listValue="%{codice + ' - ' + descrizione}" data-causale-EP-uid="%{uidOldCausaleDecremento}" />
											</div>
										</div>
									</div>									
									<div class="control-group">
						...
						<p class="margin-medium">
							...
							<button type="button" class="btn reset">annulla</button>
							 --%>
							 <s:a action="aggiornaTipoBeneCespite" cssClass="btn" id="annulla">
								<s:param name="uidTipoBeneCespite" value="%{tipoBeneCespite.uid}" />
								annulla
							</s:a>
