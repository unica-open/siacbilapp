...
<body>
			...
			<div class="span12 ">
				<div class="contentPage">
					<s:form id="formInserisciTipoBene" cssClass="form-horizontal" novalidate="novalidate" action="ricercaCategoriaCespiti_effettuaRicerca">
						<h3 id="titolo">Ricerca categoria cespite </h3>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/cespiti/categoriacespiti/ricercaCategoriaCespiti.js"></script>
</body>
</html>