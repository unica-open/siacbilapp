...
<body>
							...
							<table class="table table-hover tab_left dataTable" id="tabellaRisultatiRicercaCespite">
								<thead>
									<tr>
										<th>Cespite</th>
										<th>Tipo bene</th>
										<th class="tab_Right"><abbr title="Numero">N.</abbr> inventario</th>
										<th class="tab_Right">Data ingresso inventario</th>
										<th class="tab_Right">Valore iniziale</th>
										<th class="tab_Right">Valore attuale</th>
										<th class="tab_Right">Ammortamento</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/cespiti/ammortamento/risultatiRicercaCespiteAnteprimaAmmortamento.js"></script>
</body>
</html>