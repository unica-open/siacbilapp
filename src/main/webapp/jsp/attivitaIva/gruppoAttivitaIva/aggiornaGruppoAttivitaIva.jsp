		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					<s:form cssClass="form-horizontal" action="aggiornamentoGruppoAttivitaIva" id="formAggiornamentoGruppoAttivitaIva" novalidate="novalidate">
								...
								<fieldset class="form-horizontal">
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:hidden name="gruppoAttivitaIva.codice" data-maintain="" />
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:select list="listaAttivitaIva" multiple="true" id="listaAttivitaIva" cssClass="span10 chosen-select"
												...
												data-placeholder="Seleziona l'attività" value="%{gruppoAttivitaIva.listaAttivitaIva.{uid}}" />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:select list="listaTipoChiusura" id="tipoChiusura" name="tipoChiusura" cssClass="lbTextSmall span6" headerKey="" headerValue="" />
										</div>
									</div>
									<div class="control-group">
