		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					<s:form cssClass="form-horizontal" action="inserimentoGruppoAttivitaIva" id="formInserimentoGruppoAttivitaIva" novalidate="novalidate">
						<s:include value="/jsp/include/messaggi.jsp" />
						<h3>Inserisci gruppo attivit&agrave; iva</h3>
							...
							<div class="step-pane active">
								...
								<fieldset class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:select list="listaTipoAttivita" id="tipoAttivita" name="tipoAttivita" cssClass="lbTextSmall span6" headerKey="" headerValue="" required="true" />
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:select list="listaTipoChiusura" id="tipoChiusura" name="tipoChiusura" cssClass="lbTextSmall span6" required="true" headerKey="" headerValue="" />
										</div>
									</div>
									<div class="control-group">
										<label for="percentualeProRataProRataEChiusuraGruppoIva" class="control-label">&#37; Pro-rata *</label>
										<div class="controls">
											<s:textfield id="percentualeProRataProRataEChiusuraGruppoIva" name="proRataEChiusuraGruppoIva.percentualeProRata" maxlength="6" cssClass="lbTextSmall span2 soloNumeri decimale" placeholder="%{'percentuale'}" required="true" />
										</div>
									</div>
									<div class="control-group">
										<label for="ivaPrecedenteProRataEChiusuraGruppoIva" class="control-label">Iva a credito precedente (negativa)</label>
										<div class="controls">
											<s:textfield id="ivaPrecedenteProRataEChiusuraGruppoIva" name="proRataEChiusuraGruppoIva.ivaPrecedente" cssClass="lbTextSmall span6 soloNumeri decimale" placeholder="%{'iva'}" />
										</div>
									</div>
								</fieldset>
							</div>
