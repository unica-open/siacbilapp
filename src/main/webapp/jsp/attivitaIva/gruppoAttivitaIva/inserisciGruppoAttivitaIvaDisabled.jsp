		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					<s:form cssClass="form-horizontal" action="inserisciGruppoAttivitaIvaAggiornamento" id="formInserimentoGruppoAttivitaIva" novalidate="novalidate">
							...
							<div class="step-pane active">
								...
								<fieldset class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:select list="listaAttivitaIva" multiple="true" id="listaAttivitaIva" cssClass="span10 chosen-select"
												...
												data-placeholder="Seleziona l'attività" value="%{gruppoAttivitaIva.listaAttivitaIva.{uid}}" required="true" disabled="true" />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:select list="listaTipoChiusura" id="tipoChiusura" name="tipoChiusura" cssClass="lbTextSmall span6" headerKey="" headerValue="" disabled="true" data-maintain="" />
										</div>
									</div>
									<div class="control-group">
