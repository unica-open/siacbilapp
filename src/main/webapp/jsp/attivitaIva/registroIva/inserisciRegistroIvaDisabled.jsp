		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					<s:form cssClass="form-horizontal" action="inserisciRegistroIvaAggiornamento" id="formInserimentoRegistroIva" novalidate="novalidate">
							...
							<div class="step-pane active">
								...
								<fieldset class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:select list="listaTipoRegistroIva" id="tipoRegistroIva" name="tipoRegistroIva" cssClass="span6" headerKey="" headerValue="" listValue="%{codice + ' - ' + descrizione}" disabled="true" data-maintain="" />
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:textarea id="descrizioneRegistroIva" name="registroIva.descrizione" cssClass="input-medium span9" cols="15" rows="1" disabled="true" data-maintain=""></s:textarea>
										</div>
									</div>
									<%-- SIAC-6276 CR-1179B --%>
									<div class="control-group">
										...
										<div class="controls">
											<s:checkbox id="flagLiquidazioneIva" name="registroIva.flagLiquidazioneIva" disabled="true" /> 
										</div>
									</div>
								</fieldset>
							</div>
