							...
							<div class="step-pane active">
								...
								<fieldset class="form-horizontal">
									...
									<div class="control-group" >
										...
										<div class="controls">
											<s:textfield id="numeroProtocolloDefinitivoSubdocumentoIva" name="numeroProtocolloDefinitivo" cssClass="lbTextSmall span2 soloNumeri" placeholder="%{'numero'}" data-maintain="" />
										</div>
									</div>
									<s:if test="%{protocolloProvvisorioModificabile}">
										<div class="control-group" >
											...
											<div class="controls">
												<s:textfield id="numeroProtocolloProvvisorioSubdocumentoIva" name="numeroProtocolloProvvisorio" cssClass="lbTextSmall span2 soloNumeri" placeholder="%{'numero'}" data-maintain="" />											
											</div>
										</div>
									</s:if>
								</fieldset>
