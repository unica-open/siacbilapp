...
<body>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/variazioni/variazioniImporti.js"></script>
	<script type="text/javascript" src="/siacbilapp/js/local/variazioni/consulta.importi.ueb.js"></script>
</body>
</html>