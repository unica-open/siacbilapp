...
<body>
					...
					<div class="step-content">
						<div class="step-pane active" id="step2">
							...
							<s:if test="%{model.isDecentrato}">
								<div class="control-group">
									<label class="control-label" for="descrizioneVariazione">Data Apertura Proposta</label>
									<div class="controls">
										<span class="help-inline">${definisci.dataAperturaFormatted}</span>
									</div>
								</div>
								<div class="control-group">
								<label class="control-label" for="direzioneProponente">Direzione Proponente *</label>
								<div class="controls">
									<s:if test="%{model.definisci.listaDirezioni.size > 1}">
										<s:select list="definisci.listaDirezioni" cssClass="span10" id="direzioneProponente" name="definisci.direzioneProponente.uid" headerValue="" headerKey="" listKey="uid" listValue="%{codice + ' - ' + descrizione}" />
									</s:if>
									<s:else>
										<span class="help-inline">${definisci.direzioneProponente.codice}&nbsp;&nbsp;-&nbsp;&nbsp;${definisci.direzioneProponente.descrizione}</span>
									</s:else>
								</div>
							</div>
							</s:if>
							...
							<div class="control-group">
								<span class="control-label wider">Variazione con approvazione di <s:property value="definisci.etichettaGiunta"/>&nbsp;</span>
								<div class="controls">
	...
	<script type="text/javascript" src="${jspath}variazioni/variazioni.step2.js"></script>
</body>
</html>