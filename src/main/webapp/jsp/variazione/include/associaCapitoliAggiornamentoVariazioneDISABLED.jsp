...
<%-- 	<s:include value ="/jsp/variazione/include/ricercaCapitoloNellaVariazione.jsp"/> --%>
	...
	<div class="control-group">
		...
		<div class="controls">
			<s:textfield id="descrizioneVariazione" placeholder="descrizione" cssClass="span10" name="descrizione" maxlength="500" required="true" readonly="true" />
		</div>
	</div>
	<div class="control-group">
		<label for="noteVariazione" class="control-label">Note</label>
		<div class="controls">
			<s:textarea rows="2" cols="55" cssClass="span10" id="noteVariazione" name="note" maxlength="500" readonly="true"></s:textarea>
		</div>
	</div>
	
	<s:include value="/jsp/provvedimento/ricercaProvvedimentoCollapseDISABLED.jsp"/>
	<!-- PROVVEDIMENTO OPZIONALE -->
	<s:include value ="/jsp/provvedimento/ricercaProvvedimentoAggiuntivoCollapseDISABLED.jsp"/>
	<div>
		<div>
			<div>
				<p>&nbsp;</p>
					...
					<fieldset class="form-horizontal">
						<div class="control-group">
							...
							<div class="controls">
								...
								<s:hidden name="decentratoDisabled" value  = "DISABILITA_DA_DECENTRATO" />
							</div>
						</div>
						<div class="control-group">
