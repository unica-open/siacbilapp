	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				...
				<s:form cssClass="form-horizontal" action="esecuzioneStep3InserimentoVariazioniImportiConUEB" novalidate="novalidate" id="formVariazioneStep3_VariazioneBilancioConUEB" method="post">
					<h3>Inserisci Variazione<span class="pull-right">Numero: <s:property value="numeroVariazione"/></span></h3>
					...
					<div class="step-content">
						<div class="step-pane active" id="step3">
							<h4>Seleziona capitolo da variare</h4>
							<fieldset class="form-horizontal">
								<div class="control-group">
									<span class="control-label">Capitolo</span>
									<div class="controls">
										<label class="radio inline">
											<input type="radio" name="specificaUEB.tipoCapitolo" id="tipoCapitoloRadio1" value="Entrata" <s:if test='%{specificaUEB.tipoCapitolo eq "Entrata"}'>checked="checked"</s:if>>&nbsp;Entrata
										</label>
										<label class="radio inline">
											<input type="radio" name="specificaUEB.tipoCapitolo" id="tipoCapitoloRadio2" value="Uscita" <s:if test='%{specificaUEB.tipoCapitolo eq "Uscita"}'>checked="checked"</s:if>>&nbsp;Spesa
										</label>
										...
										<s:hidden name="specificaUEB.rientroDaInserimentoNuovaUEB" id="HIDDEN_rientroDaInserimentoNuovaUEB" data-maintain="" />
									</div>
								</div>
								<div class="control-group">
							...
							<div id="divRicercaCapitolo" class="hide">
								...
								<s:hidden name="specificaUEB.numeroUEB" id="maxNumeroUEB" data-maintain="" />
								...
								<div class="pull-centered margin-large">
									<a class="btn btn-collapse pull-center" data-parent="#accordion2" id="collapseGestioneUEB">
								...
								<div id="collapseUEB" class="collapse-body collapse">
									<div class="collapse-inner">
										<div id="div_elencoUEB">
											...
											<p>
												<button class="btn" id="redirezioneNuovaUEBButton">nuova UEB</button>
											</p>
										</div>										
									</div>
								</div>
							...
							<div class="accordion-group">
								<div class="accordion-heading">
									<a class="accordion-toggle collapsed" href="#gestioneVariazioniCapitoli" data-parent="#accordion2" data-toggle="collapse">
										Gestione modifiche capitoli selezionati <span class="icon"></span>
									</a>
								</div>
								<div id="gestioneVariazioniCapitoli" class="accordion-body in collapse" style="height: auto;">
									<div class="accordion-inner">
										<h5>Elenco modifiche</h5>
										...
										<p>
											<input class="btn" type="button" value="nuova ricerca" id="nuovaRicerca" /> <%-- Javascript per chiudere tutto --%>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<s:textarea rows="2" cols="55" cssClass="span10" id="noteVariazione" name="specificaUEB.note" maxlength="500"></s:textarea>
								</div>
							</div>
					...
					<div id="editStanziamenti" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="row-fluid overlay-modale">
							<div class="modal-header">
								...
								<h3 id="myModalLabel">Modifica gli importi - Anno di competenza selezionato: <s:property value="%{specificaUEB.annoCapitolo}"/></h3>
							</div>
							<div class="modal-body">
								<div class="alert alert-error hide" id="ERRORI_modaleEditStanziamenti">
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:if test="%{isResiduoEditabile}"> 
												...
												<s:textfield id="residuoVariazioneUEB" cssClass="lbTextSmall span6 text-right decimale soloNumeri" disabled ="true" name="residuoVariazioneUEB" />
											</s:else>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<s:if test="%{isCassaEditabile}">
												...
												<s:textfield id="cassaVariazioneUEB" cssClass="lbTextSmall span6 text-right decimale soloNumeri" disabled="true" name="cassaVariazioneUEB" />
											</s:else>
										</div>
									</div>
								</fieldset>
