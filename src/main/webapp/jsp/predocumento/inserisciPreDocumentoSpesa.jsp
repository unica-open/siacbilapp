	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="inserimentoPreDocumentoSpesa" id="formInserimentoPreDocumentoSpesa" novalidate="novalidate" >
...
<!-- 														<button type="button" id="BUTTON_deselezionaStrutturaAmministrativoContabile" class="btn btn-secondary">deseleziona</button> -->
	...
	<script type="text/javascript" src="/siacbilapp/js/local/predocumento/inserisciSpesa.js"></script>
