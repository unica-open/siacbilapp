	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="inserimentoPreDocumentoEntrata" id="formInserimentoPreDocumentoEntrata" novalidate="novalidate" >
...
<!-- 														<button type="button" id="BUTTON_deselezionaStrutturaAmministrativoContabile" class="btn btn-secondary">deseleziona</button> -->
					...
					<p class="margin-medium">
						...
						<s:submit cssClass="btn btn-primary pull-right" value="salva e ripeti" action="inserisciPreDocumentoEntrata_inserimentoRipetizione" />
					</p>
				</s:form>
			</div>
		</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/predocumento/inserisciEntrata.js"></script>
