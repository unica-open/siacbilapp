			...
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal">
					...
					<fieldset class="form-horizontal">
							...
							<div class="boxOrInLeft">
								...
								<ul class="htmlelt">
									...
									<li>
										<dfn>Causale</dfn>
										<dl>
											<s:property value="preDocumento.causaleEntrata.codice"/> - <s:property value="preDocumento.causaleEntrata.descrizione"/> -
											<s:property value="preDocumento.causaleEntrata.tipoCausale.codice"/> - <s:property value="preDocumento.causaleEntrata.tipoCausale.descrizione"/>
										</dl>
									</li>
									<li>
										<dfn>Conto corrente</dfn>
										<dl><s:property value="preDocumento.contoCorrente.codice"/> - <s:property value="preDocumento.contoCorrente.descrizione"/></dl>
									</li>
									<li>
						...
						<div class="boxOrSpan2">
							<div class="boxOrInLeft ">
								<p>Estremi predisposizione incasso</p>
								<ul class="htmlelt">
									<li>
									...
									<li>
										...
										<dl><s:property value="preDocumento.dataTrasmissione" />&nbsp;</dl>
									</li>
									<li>
										<dfn>Importo</dfn>
								...
								<ul class="htmlelt">
									...
									<s:if test="%{ordinativoSubCollegato != null }">
										...
										<li>
											...
											<dl><s:property value="capitolo.annoCapitolo"/>&nbsp;/&nbsp;<s:property value="capitolo.numeroCapitolo"/>&nbsp;/&nbsp;<s:property value="capitolo.numeroArticolo"/></dl><%-- /<s:property value="capitolo.numeroUEB}"/></dl>--%>
										</li>
										<li>
										...
										<li>
											...
											<dl><s:property value="soggettoOrdinativo.codiceSoggetto"/>&nbsp;/&nbsp;<s:property value="soggettoOrdinativo.denominazione"/></dl>
										</li>
									</s:if>
									<s:else>
										<li>
