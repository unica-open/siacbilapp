	...
	<tbody>
		<s:iterator value="consultazioneHelper.listaModificaMovimentoGestione" var="mmg">
			<tr>
				...
				<td class="tab_Right"><s:property value="#mmg.domStringModificaDiImporto" escape="false" /></td>
			</tr>
		</s:iterator>
	</tbody>
</table>
	...
	<div class="boxOrInRight-multi">
		<div class="boxOrInLeft-multi">
			...
			<ul class="htmlelt">
				<li>
					<dfn>Codice</dfn>
					<dl><s:property value="consultazioneHelper.soggetto.codiceSoggetto"/></dl>
				</li>
				<li>
					<dfn>Denominazione</dfn>
					<dl><s:property value="consultazioneHelper.soggetto.denominazione"/></dl>
				</li>
				<li>
					<dfn>Codice Fiscale</dfn>
					<dl><s:property value="consultazioneHelper.soggetto.codiceFiscale"/></dl>
				</li>
				<li>
					<dfn>Partita IVA</dfn>
					<dl><s:property value="consultazioneHelper.soggetto.partitaIva"/></dl>
				</li>
			</ul>
		</div>
		<div class="boxOrInRight-multi">
