...
<body>
								...
								<div class="span12">
									<div class="span4">
										<div class="control-group margin-medium">
											...
											<div class="controls">
												<s:textfield id="importoDaRegistrare" name="importoDaRegistrare" cssClass="span4 soloNumeri decimale text-right tab_Right" disabled="%{aggiornamento}"/>
										...
										<div class="control-group margin-medium">
											...
											<div class="controls">
												<s:textfield id="daRegistrare" name="daRegistrare" cssClass="span4 soloNumeri decimale text-right tab_Right" readonly="true" />
											</div>
										</div>
									</div>
									<%-- SIAC-8134 --%>
									<div class="span8">
										<div id="fieldsetStrutturaCompetente">
											...
											<s:hidden id="HIDDEN_StrutturaAmministrativoContabileUid_PRIMA_NOTA_LIBERA" name="strutturaCompetentePrimaNotaLibera.uid" />
											<s:hidden id="HIDDEN_StrutturaAmministrativoContabileCodice_PRIMA_NOTA_LIBERA" name="strutturaCompetentePrimaNotaLibera.codice" />
											<s:hidden id="HIDDEN_StrutturaAmministrativoContabileDescrizione_PRIMA_NOTA_LIBERA" name="strutturaCompetentePrimaNotaLibera.descrizione" />
										</div>
									</div>
									<%-- SIAC-8134 --%>
								</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/contabilitaGenerale/primaNotaLibera/inserisci.aggiorna.step2.js"></script>
