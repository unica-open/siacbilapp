...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">    
				<s:form cssClass="form-horizontal" action="ricercaPrimaNotaLiberaFIN_effettuaRicerca" novalidate="novalidate" id="formPrimaNotaLibera">
	...
	<script type="text/javascript" src="/siacbilapp/js/local/contabilitaGenerale/primaNotaLibera/ricerca.js"></script>
</body>
</html>