...
<body>
				...
				<s:form cssClass="form-horizontal" action="#" novalidate="novalidate" id="formPrimaNotaLibera">
					...
					<p class="margin-medium">
						...
						<span class="pull-right">
							<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modaleConfermaValidazioneMassiva">valida tutto</button>
						</span>
					</p>
				</s:form>
				<s:include value="/jsp/contabilitaGenerale/primaNotaIntegrata/include/modaleConfermaValidazioneMassiva.jsp" />
	...
	<script type="text/javascript" src="${jspath}contabilitaGenerale/primaNotaIntegrata/risultatiRicercaValidazione.js"></script>
