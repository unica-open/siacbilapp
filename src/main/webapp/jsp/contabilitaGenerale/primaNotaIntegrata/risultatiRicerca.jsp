...
<body>
	...
	<script type="text/javascript" src="${jspath}contabilitaGenerale/primaNotaIntegrata/risultatiRicerca.js"></script>
	<script type="text/javascript" src="${jspath}contabilitaGenerale/primaNotaIntegrata/rateiRisconti.js"></script>
	<script type="text/javascript" src="${jspath}contabilitaGenerale/primaNotaIntegrata/gestioneRateiRisconti.js"></script>
</body>
</html>