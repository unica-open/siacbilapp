			...
			<form class="form-horizontal">
				...
				<h3>Piano dei Conti <s:property value="conto.pianoDeiConti.descrizione"/>- Classe <s:property value="conto.pianoDeiConti.classePiano.codice"/> </h3>
					...
					<div class="step-pane active" id="step1">
						...
						<h4 class="step-pane">Inserimento: <s:property value="conto.dataCreazione"/> (<s:property value="conto.loginCreazione"/>)- 
									Ultima modifica: <s:property value="conto.dataModificaConto"/> (<s:property value="conto.loginModifica"/>)
						</h4> 
									...
									<p>Dati aggiuntivi</p>
										<ul class="htmlelt">
											<li>
												...
												<dl><s:property value="conto.codiceBilancio.codice"/>-<s:property value="conto.codiceBilancio.descrizione"/></dl>
											</li>
											<li>
												<dfn>A Partite</dfn> 
												<dl>
											...
											<li>
												...
												<dl><s:property value="conto.elementoPianoDeiConti.codice"/>-<s:property value="conto.elementoPianoDeiConti.descrizione"/></dl>
											</li>
										</ul>								
									</s:if>
