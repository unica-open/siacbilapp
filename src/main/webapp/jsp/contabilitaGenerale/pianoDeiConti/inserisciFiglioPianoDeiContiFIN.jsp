...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="inserisciFiglioPianoDeiContiFIN_inserimento" id="formInserimentoFiglioPianoDeiConti" >
							...
							<s:hidden id="HIDDEN_contiFiglioSenzaFigli" name="contiFiglioSenzaFigli"/>
								...
								<div id="campiAggiuntivi" class="hide">
									...
									<div class="control-group">
										...
										<div class="controls">
											<s:textfield id="pianoDeiContiFinanziario" name="conto.elementoPianoDeiConti.codice" cssClass="span6" disabled="figlioNonDiLegge" />
											<s:if test="figlioNonDiLegge">
												<s:hidden name="conto.elementoPianoDeiConti.codice" />
											</s:if>
											<span class="radio guidata">
												<a class="btn btn-primary <s:if test='%{figlioNonDiLegge || contoFinGuidataDisabled}'>disabled</s:if>" id="pulsanteCompilazioneGuidataContoFIN">compilazione guidata</a>
											</span>
										</div>
									</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/contabilitaGenerale/pianoDeiConti/inserisciFiglioPianoDeiContiFIN.js"></script>
