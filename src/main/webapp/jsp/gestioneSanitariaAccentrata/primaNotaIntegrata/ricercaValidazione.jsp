	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				...
				<s:form cssClass="form-horizontal" action="ricercaValidazionePrimaNotaIntegrataGSA_effettuaRicerca" novalidate="novalidate" id="formPrimaNotaIntegrata">
												...
												<div class="accordion-group">
													<div class="accordion-heading">
														<a class="accordion-toggle" id="accordionPadreStrutturaAmministrativa" href="#struttAmmCap">
															<%-- MANCAVA UN 'Cap' al termine dell'id. Ora funge, ma devi deployare --%>
