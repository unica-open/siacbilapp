		...
		<div class="step-pane active">
			...
			<fieldset id="fieldsetCollapseInserimentoConto">
				<div class="control-group">
					<label class="control-label" for="uidClassePianoPianoDeiContiContoContoTipoOperazione">Classe <span id="classeObbligatoria">*</span></label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<s:select list="classiDiConciliazione" name="contoTipoOperazione.classeDiConciliazione" id="classeDiConciliazione" cssClass="span6" required="true"
							headerKey="" headerValue="" listValue="descrizione" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="codiceContoContoTipoOperazione">Codice conto <span id="contoObbligatorio">*</span></label>
					<div class="controls">
