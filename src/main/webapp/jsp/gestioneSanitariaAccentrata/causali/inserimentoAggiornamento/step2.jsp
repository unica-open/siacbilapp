...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
					...
					<div class="step-content">
						<div id="step2" class="step-pane active">
							<fieldset class="form-horizontal">
								...
								<s:include value="/jsp/gestioneSanitariaAccentrata/causali/include/collapseInserimentoConto.jsp" />
							</fieldset>
						</div>
					</div>
				...
				<s:include value="/jsp/gestioneSanitariaAccentrata/causali/include/modaleAggiornamentoConto.jsp" />
				<s:include value="/jsp/gestioneSanitariaAccentrata/causali/include/modaleEliminazione.jsp" />
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/gestioneSanitariaAccentrata/causali/inserisci.aggiorna.step2.js"></script>
