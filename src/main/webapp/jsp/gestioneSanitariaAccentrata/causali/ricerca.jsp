...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="effettuaRicercaCausaleEPGSA" novalidate="novalidate" id="formCausaleEP">
						...
						<div id="step1" class="step-pane active">
							<fieldset class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<s:select list="listaClassiDiConciliazione" name="classeDiConciliazione" id="classeDiConciliazione" cssClass="span6" required="true"
											headerKey="" headerValue="" listValue="descrizione" />
									</div>
								</div>
								<%--<div class="control-group">
	...
	<script type="text/javascript" src="/siacbilapp/js/local/gestioneSanitariaAccentrata/causali/ricerca.js"></script>
