...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="aggiornaPianoDeiContiGSA_aggiornamento" id="formAggiornaPianoDeiConti" >
	...
	<script type="text/javascript" src="/siacbilapp/js/local/gestioneSanitariaAccentrata/pianoDeiConti/aggiornaPianoDeiContiGSA.js"></script>
