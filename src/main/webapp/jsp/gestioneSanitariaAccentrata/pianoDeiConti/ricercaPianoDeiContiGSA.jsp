...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="ricercaPianoDeiContiGSA" id="formRicercaPianoDeiConti">
					...
					<div class="step-content">
						<div class="step-pane active" id="step1">
							...
							<div id = "risultatiRicercaPianoDeiConti" class="hide">
									<s:include value="/jsp/gestioneSanitariaAccentrata/pianoDeiConti/risultatiRicercaPianoDeiContiGSA.jsp" />
							</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/gestioneSanitariaAccentrata/pianoDeiConti/risultatiRicercaPianoDeiContiGSA.js"></script>
</body>
</html>