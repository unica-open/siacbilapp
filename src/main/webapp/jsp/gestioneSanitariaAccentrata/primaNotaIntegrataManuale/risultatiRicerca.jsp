...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="#" novalidate="novalidate" id="formPrimaNotaIntegrataManuale">
					<s:include value="/jsp/include/messaggi.jsp" />
					<h3>Risultati ricerca prima nota integrata manuale</h3>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/gestioneSanitariaAccentrata/primaNotaIntegrataManuale/risultatiRicerca.js"></script>
