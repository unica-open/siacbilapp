		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="span12 contentPage">
					<s:form action="effettuaRicercaDocumentoEntrata" cssClass="form-horizontal" novalidate="novalidate">
								...
								<fieldset class="form-horizontal">
									<div class="control-group">
										...
										<div class="controls">
											...
											<!-- SIAC-6565 -->
											<span class="al">
												<label class="radio inline" for="statoSDIDocumento">Stato SDI</label>
													<s:select id="statoSDIDocumento" list="listaStatoSDIDocumento" name="documento.statoSDI"
														required="false" headerKey="" headerValue="" listKey="codice" listValue="descrizione" />
											</span>											
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield id="movimentoGestione.anno" cssClass="lbTextSmall span2" name="accertamento.annoMovimento" maxlength="4" placeholder="anno" />
											<span class="al">
												<label class="radio inline" for="movimentoGestione.numero">Numero</label>
											</span>
											<s:textfield id="movimentoGestione.numero" cssClass="lbTextSmall span2" name="accertamento.numero" placeholder="numero" value="%{accertamento.numero.toString()}" />
										</div>
									</div>
									<div class="control-group">
