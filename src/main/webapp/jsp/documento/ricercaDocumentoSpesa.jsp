...
<body>
		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="span12 contentPage">
					<s:form action="effettuaRicercaDocumentoSpesa" cssClass="form-horizontal" novalidate="novalidate">
						...
						<div class="step-content">
							<div class="step-pane active" id="step1"> <br/>
								...
								<fieldset class="form-horizontal">
									...
									<div class="control-group">
										<label class="control-label" for="flagCollegatoCEC">Collegato a cassa economale</label>
										<div class="controls">
											<select id="flagCollegatoCEC" name="flagCollegatoCEC">
												<option value=""  <s:if test='flagCollegatoCEC == ""' >selected</s:if>>Non si applica</option>
												<option value="S" <s:if test='flagCollegatoCEC == "S"'>selected</s:if>>S&iacute;</option>
												<option value="N" <s:if test='flagCollegatoCEC == "N"'>selected</s:if>>No</option>
											</select>
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield id="elenco.anno" cssClass="lbTextSmall span2" name="elencoDocumenti.anno" maxlength="4" placeholder="anno" />
											<span class="al">
												<label class="radio inline" for="elenco.numero">Numero</label>
											</span>
											<s:textfield id="elenco.numero" cssClass="lbTextSmall span2" name="elencoDocumenti.numero" placeholder="numero" />
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<span class="al">
												<label class="radio inline" for="movimentoGestione.anno">Anno</label>
											</span>
											<s:textfield id="movimentoGestione.anno" cssClass="lbTextSmall span2" name="impegno.annoMovimento" maxlength="4" placeholder="anno" />
												<span class="al">
												<label class="radio inline" for="movimentoGestione.numero">Numero</label>
											</span>
											<s:textfield id="movimentoGestione.numero" cssClass="lbTextSmall span2" name="impegno.numero" placeholder="numero" value="%{impegno.numero.toString()}" />
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<span class="al">
												<label class="radio inline" for="annoRepertorio">Anno</label>
											</span>
											<s:textfield id="annoRepertorio" cssClass="lbTextSmall span2" name="documento.annoRepertorio" maxlength="4" placeholder="anno" />
											<span class="al">
												<label class="radio inline" for="dataRepertorio">Data</label>
											</span>
											<s:textfield id="dataRepertorio" cssClass="lbTextSmall span2 datepicker" name="documento.dataRepertorio" placeholder="data" />
											<span class="al">
												<label class="radio inline" for="numeroRepertorio">Numero</label>
											</span>
											<s:textfield id="numeroRepertorio" cssClass="lbTextSmall span2" name="documento.numeroRepertorio" placeholder="numero" />
											<span class="al">
												<label class="radio inline" for="registroRepertorio">Registro (AOO)</label>
											</span>
											<s:textfield id="registroRepertorio" cssClass="lbTextSmall span2" name="documento.registroRepertorio" />
									...
									<div class="control-group">
										<span class="al">
											<label class="radio inline" for="numeroPredisposizionePagamento">Numero predisposizione di pagamento</label>
										</span>
										<s:textfield id="numeroPredisposizionePagamento" cssClass="lbTextSmall span2" name="predocumento.numero" />
									</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/documento/ricercaSpesa.js"></script>
