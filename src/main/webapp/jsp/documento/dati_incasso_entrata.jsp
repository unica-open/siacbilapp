...
<div id="datiIncassoDiv" class="step-pane active">
	<div class="accordion">
		<div class="accordion-group">
			<div class="accordion-heading">
				<a href="#datiIncassoAccordion" data-parent="#datiIncassoDiv" data-toggle="collapse" class="accordion-toggle">
					Dati incasso<span class="icon">&nbsp;</span>
				</a>
			</div>
			<div class="accordion-body collapse" id="datiIncassoAccordion">
