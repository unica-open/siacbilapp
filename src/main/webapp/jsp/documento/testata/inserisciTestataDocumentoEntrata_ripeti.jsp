...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="inserisciTestataDocumentoEntrata_ripetiSalva" id="formInserimentoDocumentoEntrata" novalidate="novalidate" >
					<s:include value="/jsp/include/messaggi.jsp" />
					<s:hidden id="HIDDEN_anno_datepicker" value="%{documento.anno}" />
					<h3>Ripeti Documento iva entrata</h3>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/documento/inserisciTestataEntrata.js"></script>
