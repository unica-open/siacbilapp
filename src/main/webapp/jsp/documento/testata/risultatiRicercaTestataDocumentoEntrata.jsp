			...
			<div class="span12 ">
				<div class="contentPage">
					...
					<form method="post" action="#">
						<h3>Risultati di ricerca  Documenti iva entrata</h3>
						...
						<div id="msgAnnulla" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="msgAnnullaLabel" aria-hidden="true">
							...
							<div class="modal-footer">
								...
								<button class="btn btn-primary" formmethod="post" type="submit" formaction="risultatiRicercaTestataDocumentoEntrataAnnulla.do">s&iacute;, prosegui</button>
							</div>
						</div>
						<p>
