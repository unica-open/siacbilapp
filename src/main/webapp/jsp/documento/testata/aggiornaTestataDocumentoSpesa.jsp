		...
		<div class="row-fluid">
			<div class="span12 contentPage">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#tabAggiornamentoDocumento">Documenti iva spesa</a></li>
					<li><a data-toggle="tab" href="#tabDatiIva">Dati iva</a></li>
				</ul>
				<div class="tab-content noOverflow">
					<div id="tabAggiornamentoDocumento" class="tab-pane fade in active">
						<s:include value="/jsp/documento/aggiornamento/testata/aggiornamentoTestataDocumentoSpesa.jsp" />
					</div>
					<div id="tabDatiIva" class="tab-pane fade">
						<s:include value="/jsp/documento/aggiornamento/testata/datiIvaTestataDocumentoSpesa.jsp" />
					</div>
				</div>
			</div>
		</div>
