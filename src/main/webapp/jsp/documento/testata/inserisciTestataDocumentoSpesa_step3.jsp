			...
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal">
					...
					<p class="margin-medium">
						...
						<s:submit cssClass="btn btn-secondary" action="inserisciTestataDocumentoSpesa_aggiorna" value="aggiorna" />
						<s:submit cssClass="btn btn-secondary" action="inserisciTestataDocumentoSpesa_ripeti" value="ripeti" />
					</p>
				</s:form>
			</div>
		</div>
