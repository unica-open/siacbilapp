	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="inserisciTestataDocumentoEntrataEnterStep3" id="formInserimentoDocumentoEntrata" novalidate="novalidate" >
					...
					<p class="margin-medium">
						<s:a cssClass="btn" action="inserisciTestataDocumentoEntrataReturnToStep1" id="pulsanteRedirezioneIndietro">indietro</s:a>
