			...
			<div class="span12 ">
				<div class="contentPage">
					...
					<form method="post" action="#">
						<h3>Risultati di ricerca  Documenti di spesa</h3>
						...
						<div id="msgAnnulla" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="msgAnnullaLabel" aria-hidden="true">
							...
							<div class="modal-footer">
								...
								<button class="btn btn-primary" formmethod="post" type="submit" formaction="risultatiRicercaDocumentoSpesaAnnulla.do">si, prosegui</button>
							</div>
						</div>
						<p>
