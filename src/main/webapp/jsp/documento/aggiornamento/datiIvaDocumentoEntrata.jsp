		...
		<p>
			<span class="pull-right">
				<s:if test="documentoIvaLegatoDocumentoPresente">
					<a class="btn btn-primary" href="aggiornamentoDocumentoEntrata_redirezioneAggiornamentoDocumentoIvaEntrata_documento.do?uidSubdocumentoIva=<s:property value="subdocumentoIva.uid" />">aggiorna documento iva di entrata</a>
				</s:if><s:else>
					<a class="btn btn-primary" href="aggiornamentoDocumentoEntrata_redirezioneInserimentoDocumentoIvaEntrata_documento.do">inserisci documento iva di entrata</a>
				</s:else>
			</span>
		</p>
	</div>
