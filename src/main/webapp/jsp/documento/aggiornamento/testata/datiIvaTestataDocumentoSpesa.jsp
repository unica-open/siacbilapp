		...
		<p>
			<span class="pull-right">
				<s:if test="documentoIvaLegatoDocumentoPresente">
					<a class="btn btn-primary" href="aggiornamentoTestataDocumentoSpesa_redirezioneAggiornamentoDocumentoIvaSpesa_documento.do?uidSubdocumentoIva=<s:property value="subdocumentoIva.uid" />">aggiorna documento iva di spesa</a>
				</s:if><s:else>
					<a class="btn btn-primary" href="aggiornamentoTestataDocumentoSpesa_redirezioneInserimentoDocumentoIvaSpesa_documento.do">inserisci documento iva di spesa</a>
				</s:else>
			</span>
		</p>
	</div>
