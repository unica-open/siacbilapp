...
<s:form id="formAggiornamentoDatiDocumento" cssClass="form-horizontal" novalidate="novalidate" action="aggiornamentoTestataDocumentoSpesa_aggiornamentoAnagrafica">
	<h4 class="step-pane">Dati principali</h4>
	<div class="control-group">
		<label for="siopeDocumentoTipo" class="control-label">Tipo documento siope *</label>
		<div class="controls">
			<select name="documento.siopeDocumentoTipo.uid" class="span6" required id="siopeDocumentoTipo">
