...
<div id="divAnagraficaIva" class="step-pane active form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<label class="radio inline">
				<s:radio theme="simple" name="tipoInserimentoDatiIva" list="#{'Documento':'Su intero documento'}"/>
			</label>
			<label class="radio inline">
				<s:radio theme="simple" name="tipoInserimentoDatiIva" list="#{'Quota':'Sui singoli dettagli del documento (quote)'}"/>
			</label>
		</div>
	</div>
	...
	<div id="inserimentoSubdocumentoIvaDocumento" <s:if test='%{!"Documento".equals(tipoInserimentoDatiIva)}'>class="hide"</s:if>>
		<div class="control-group">
		...
		<p>
			<span class="pull-right">
				<s:if test="documentoIvaLegatoDocumentoPresente">
					<a class="btn btn-primary" href="aggiornamentoTestataDocumentoEntrata_redirezioneAggiornamentoDocumentoIvaEntrata_documento.do?uidSubdocumentoIva=<s:property value="subdocumentoIva.uid" />">aggiorna documento iva di entrata</a>
				</s:if><s:else>
					<a class="btn btn-primary" href="aggiornamentoTestataDocumentoEntrata_redirezioneInserimentoDocumentoIvaEntrata_documento.do">inserisci documento iva di entrata</a>
				</s:else>
			</span>
		</p>
	</div>
