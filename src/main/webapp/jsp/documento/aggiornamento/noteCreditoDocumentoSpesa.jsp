...
<table summary="...." class="table table-hover tab_left" id="tabellaNoteCreditoDocumento">
	...
	<p>
		<s:if test="checkStatoValidoPerInserimentoNota">
			...
			<a id="pulsanteCollegaNotaCreditoEsistente" class="btn btn-secondary">
				collega nota esistente&nbsp;<i class="icon-spin icon-refresh spinner" id="SPINNER_pulsanteCollegaNotaCreditoEsistente"></i>
			</a>
		</s:if>	
	...
	<div id="accordionInserisciNotaCreditoSpesa" class="collapse">
	</div>
</fieldset>
...
<s:include value="/jsp/documento/aggiornamento/include/ricercaSpesaNotaCredito_Modale.jsp" />
<s:include value="/jsp/documento/aggiornamento/dettaglioQuoteNoteCredito_Modale.jsp" />
