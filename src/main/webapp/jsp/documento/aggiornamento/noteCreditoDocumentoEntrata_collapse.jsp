		...
		<fieldset class="form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<s:hidden id="HIDDEN_StrutturaAmministrativoContabile_NOTECREDITOUid" name="strutturaAmministrativoContabile.uid" />
					<s:hidden id="HIDDEN_StrutturaAmministrativoContabile_NOTECREDITOCodice" name="strutturaAmministrativoContabile.codice" />
					<s:hidden id="HIDDEN_StrutturaAmministrativoContabile_NOTECREDITODescrizione" name="strutturaAmministrativoContabile.descrizione" />
				</div>
			</div>
		</fieldset> 
	</fieldset>	
