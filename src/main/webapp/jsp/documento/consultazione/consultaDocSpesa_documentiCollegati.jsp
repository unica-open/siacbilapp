...
<table class="table table-hover tab_left" summary="...." id="tabellaDocumentiCollegati">
	<thead>
		<tr>
		...
		<table class="table table-hover tab_left" summary="...." id="tabellaDettaglioQuoteNoteCredito">
			...
			<tfoot>
				<tr>
					...
					<th class="tab_Right" id="modaleNoteCredito_totaleImportoDaDedurre"></th>
					<th class="tab_Right" id="modaleNoteCredito_totaleImporto"></th>
				</tr>
			</tfoot>
		</table>
	</div>
