...
<s:form id = "formSelezionaEntitaDiPartenza_capitolo" action="" cssClass="form-horizontal" novalidate="novalidate">
	<div class="fieldset-heading">
		<h4>Selezione Capitolo</h4>
	</div>
	...
	<div id="campiSelezioneCapitoloEntrata" class="hide">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select id="tipologiaTitolo" class="span10" name="tipologiaTitolo.uid" disabled="disabled">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select id="categoriaTipologiaTitolo" class="span10" name="categoriaTipologiaTitolo.uid" disabled="disabled">
					<option value="0"></option>
				</select>
			</div>
		</div>		
...
<!------------  ********* CAMPI CAPITOLO SPESA ********* ------------->
	<div id="campiSelezioneCapitoloSpesa" class="hide">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select id="macroaggregato" name="macroaggregato.uid" class="span10" disabled="disabled">
					<option value="0"></option>
				</select>
			</div>
		</div>		
	...
	<div class="control-group">
		<s:submit id = "pulsanteRicercaEntitaDiPartenzaCapitoloSpesa" data-tipo-entita= "CAPITOLOSPESA" cssClass="btn btn-primary btn-block" value="cerca" />
	</div>
</s:form>