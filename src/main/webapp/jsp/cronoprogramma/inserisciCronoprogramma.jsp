...
<body>
				...
				<div class="contentPage">
					...
					<%--s:form id="formInserisciCronoprogramma" cssClass="form-horizontal" novalidate="novalidate" action="baseUrlCronoprogramma"--%>
						...
						<div id="MyWizard" class="wizard">
							<ul class="steps">
								<li data-target="#" class="complete"><span class="badge badge-success">1</span>Progetto<span class="chevron"></span></li>
								<li data-target="#step2" class="active"><span class="badge">2</span>Cronoprogramma<span class="chevron"></span></li>
							</ul>
						</div>
						...
						<p class="margin-medium">
							<s:a cssClass="btn" action="inserimentoCronoprogramma_backToProgetto" id="pulsanteRedirezioneIndietro">indietro</s:a>
	...
	<script type="text/javascript" src="${jspath}cronoprogramma/inserisci.js"></script>
