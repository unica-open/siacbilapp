...
<div class="accordion_info">
	<fieldset id="fieldsetDettaglioEntrata" class="form-horizontal">
			...
			<div class="controls">
				...
				<span class="alRight">
					...
					<label class="radio inline">
						<input type="radio" value="si" id="daEsistenteEntrataSi" name="daEsistenteEntrata" />
						s&iacute;
					</label>
					<label class="radio inline">
						<input type="radio" value="no" id="daEsistenteEntrataNo" name="daEsistenteEntrata" checked />
						no
					</label>
				</span>
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="radio inline">
					<input type="radio" value="true" name="dettaglioEntrataCronoprogramma.isAvanzoAmministrazione" />S&iacute;
				</label>
				<label class="radio inline">
					<input type="radio" value="false" name="dettaglioEntrataCronoprogramma.isAvanzoAmministrazione" checked />No
				</label>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<s:hidden id="HIDDEN_titoloEntrataEntrata" name="dettaglioEntrataCronoprogramma.titoloEntrata.uid" disabled="true" />
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<s:select id="tipologiaTitoloEntrata" list="listaTipologiaTitolo" name="dettaglioEntrataCronoprogramma.tipologiaTitolo.uid" cssClass="span10"
					required="required" listKey="uid" listValue="%{codice + '-' + descrizione}" headerKey="" headerValue="Seleziona la tipologia" disabled="true" />
				<s:hidden id="HIDDEN_tipologiaTitoloEntrata" name="dettaglioEntrataCronoprogramma.tipologiaTitolo.uid" disabled="true" />
			</div>
		</div>
	</fieldset>

	<p>
		<a data-close-collapse="#collapseDettaglioEntrata" class="btn btn-secondary" href="#">annulla inserimento</a>
		<a data-url-fragment="InserisciDettaglioCronoprogrammaEntrata" data-close-collapse="#collapseDettaglioEntrata" class="btn btn-secondary" href="#" data-save-button>
