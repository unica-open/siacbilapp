		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					...
					<s:form method="post" action="effettuaRicercaConOperazioniCapEntrataGestione">
											...
											<div class="controls">
												...
												<s:if test="%{gestioneUEB}">
													...
													<input type="text" id="numeroUEB" class="lbTextSmall span2 soloNumeri" maxlength="200"
															name="capitoloEntrataGestione.numeroUEB" placeholder="UEB"
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="exAnnoCapitolo" class="lbTextSmall span2" maxlength="4"
															name="capitoloEntrataGestione.exAnnoCapitolo"
													...
													<input type="text" id="exCapitolo" class="lbTextSmall span2" maxlength="200"
															name="capitoloEntrataGestione.exCapitolo" placeholder="capitolo" />
													<span class="al"> 
													...
													<input type="text" id="exArticolo" class="lbTextSmall span2" maxlength="200"
															name="capitoloEntrataGestione.exArticolo" placeholder="articolo" />
													<s:if test="%{gestioneUEB}">
														<span class="al"> 
														...
														<input type="text" id="exUEB" class="lbTextSmall span2" maxlength="200"
															name="capitoloEntrataGestione.exUEB" />
													</s:if>
												</div>
											</div>
											<div class="control-group">
