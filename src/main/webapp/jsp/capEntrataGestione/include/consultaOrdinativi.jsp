...
<fieldset class="form-horizontal" id="esportazioneOrdinativiCollegati">
	<button type="button" class="pull-left btn btn-secondary" data-esportazione data-xlsx="false" data-figlio="REVERSALE" data-filters="input[name='filtroOrdinativo']:checked">
		Esporta risultati in Excel <i class="icon-download-alt icon-large"></i>&nbsp;
	</button>
	<button type="button" class="pull-left btn btn-secondary" data-esportazione data-xlsx="true" data-figlio="REVERSALE" data-filters="input[name='filtroOrdinativo']:checked">
