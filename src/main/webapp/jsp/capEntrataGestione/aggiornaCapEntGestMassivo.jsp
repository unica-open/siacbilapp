			...
			<div class="span12 ">
				...
				<div class="step-content">
					<div class="step-pane active" id="step1">
						<form method="post" action="aggiornamentoMassivoCapEntrataGestione.do" id="aggiornamentoCapEntrataGestione"
							...
							<s:hidden name="capitoloEntrataGestione.uid" />
										...
										<div class="accordion-inner">
											<fieldset class="form-horizontal">
												...
												<s:if test="flagRilevanteIvaEditabile">
													...
													<s:hidden name="capitoloEntrataGestione.flagRilevanteIva" />
												</s:else>
												...
												<s:if test="noteEditabile">
													...
													<s:hidden name="capitoloEntrataGestione.note" />
												</s:else>
											</fieldset>
										</div>
									</div>
