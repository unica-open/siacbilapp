			...
			<div class="span12 ">
				...
				<div class="step-content">
					<div class="step-pane active" id="step1">
						...
						<%-- Sezione A --%>
						<form action="inserimentoCapEntrataGestione.do" method="post" id="inserimentoCapEntrataGestione" name="formInserimento" novalidate="novalidate">
										...
										<div class="accordion-inner">
											...
											<div class="form-inline">
												...
												<input type="text" id="numeroCapitoloDaCopiare" name="capitoloDaCopiare.numeroCapitolo"
														class="input-small soloNumeri" value="${capitoloDaCopiare.numeroCapitolo}" maxlength="9"
														placeholder="capitolo" required="required" />
												...
												<input type="text" id="numeroArticoloDaCopiare" name="capitoloDaCopiare.numeroArticolo"
														class="input-small soloNumeri" value="${capitoloDaCopiare.numeroArticolo}" maxlength="9"
														placeholder="articolo" required="required" />
												<s:if test="gestioneUEB">
													<label for="numeroUEBDaCopiare" class="control-label">
														<abbr title="Unit&agrave; Elementare Bilancio">UEB</abbr>
													</label>&nbsp;
													<input type="text" id="numeroUEBDaCopiare" name="capitoloDaCopiare.numeroUEB"  class="input-small soloNumeri" maxlength="9"
															value="${capitoloDaCopiare.numeroUEB}" placeholder="UEB" required="required" />
												</s:if><s:else>
													<s:hidden name="capitoloDaCopiare.numeroUEB" data-maintain="" />
												</s:else>
												<input type="button" class="btn" value="copia" id="buttonCopia" data-url="copiaCapEntrataGestione.do" />
											</div>
										</div>
									</div>
								</div>
							...
							<h3>Inserimento Capitolo
								<s:if test="%{(capitoloEntrataGestione.numeroCapitolo != null) &&
										(capitoloEntrataGestione.numeroCapitolo != 0)}">
									<s:property value="capitoloEntrataGestione.numeroCapitolo"/>
									/
									<s:property value="capitoloEntrataGestione.numeroArticolo"/>
									<s:if test="gestioneUEB">
										/
							...
							<fieldset class="form-horizontal">
								<div class="control-group">
									...
									<div class="controls">
										...
										<s:hidden id="annoBilancio" name="bilancio.anno" value="%{annoEsercizioInt}" data-maintain="" />
										<span class="al">
										...
										<input type="text" id="numeroCapitolo" class="lbTextSmall span2 soloNumeri" required="required"
												name="capitoloEntrataGestione.numeroCapitolo" maxlength="9"
										...
										<input type="text" id="numeroArticolo" class="lbTextSmall span2 soloNumeri" required="required"
												name="capitoloEntrataGestione.numeroArticolo" maxlength="9"
										...
										<s:if test="gestioneUEB">
											...
											<input type="text" id="numeroUEB" class="lbTextSmall span2 soloNumeri" name="capitoloEntrataGestione.numeroUEB"
													maxlength="9" value="${capitoloEntrataGestione.numeroUEB}" placeholder="UEB" required="required" />
										</s:if><s:else>
											<s:hidden name="capitoloEntrataGestione.numeroUEB" data-maintain="" />
										</s:else>
										<button class="btn btn-primary" title="Verifica esistenza capitolo"
												name="action:cercaCapEntrataGestione">
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea rows="5" cols="15" id="descrizioneCapitolo" name="capitoloEntrataGestione.descrizione" class="span10"
												maxlength="500" required="required">${capitoloEntrataGestione.descrizione}</textarea>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<textarea rows="5" cols="15" id="descrizioneArticolo" name="capitoloEntrataGestione.descrizioneArticolo"
												class="span10" maxlength="500">${capitoloEntrataGestione.descrizioneArticolo}</textarea>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="hidden" id="HIDDEN_ElementoPianoDeiContiUid" name="elementoPianoDeiConti.uid"
												value="${elementoPianoDeiConti.uid}" />
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="hidden" id="HIDDEN_StrutturaAmministrativoContabileUid"
												name="strutturaAmministrativoContabile.uid" value="${strutturaAmministrativoContabile.uid}" />
								...
								<div class="control-group">
									...
									<div class="controls">
										<select id="categoriaCapitolo" name="capitoloEntrataGestione.categoriaCapitolo.uid" class="span10">
								...
								<div class="control-group <s:if test="!flagAccertatoPerCassaVisibile">hide</s:if>">
									...
									<div class="controls">
										<s:checkbox id="flagAccertatoPerCassa" name="capitoloEntrataGestione.flagAccertatoPerCassa" />
									</div>
								</div>
							</fieldset>
												...
												<div class="control-group">
													...
													<div class="controls input-append">
														<s:select id="tipoFondo" name="tipoFondo.uid" list="listaTipoFondo"
																cssClass="span10" headerKey="0" headerValue=""
																listKey="uid" listValue="%{codice + '-' + descrizione}" />
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls input-append">
														<s:select list="listaPerimetroSanitarioEntrata" id="perimetroSanitario" cssClass="span10"
																name="perimetroSanitarioEntrata.uid" headerKey="0" headerValue=""
																listKey="uid" listValue="%{codice + '-' + descrizione}" />
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls input-append">
														<s:select list="listaTransazioneUnioneEuropeaEntrata" id="transazioneUnioneEuropea" cssClass="span10"
																name="transazioneUnioneEuropeaEntrata.uid" headerKey="0" headerValue=""
																listKey="uid" listValue="%{codice + '-' + descrizione}" />
													</div>
												</div>
							...
							<table summary="riepilogo incarichi" class="table table-hover table-bordered">
								...
								<%-- Già accertato --%>
								<s:hidden name="importiCapitoloEntrataGestione0.diCuiAccertatoAnno1" data-maintain="" />
								<s:hidden name="importiCapitoloEntrataGestione0.diCuiAccertatoAnno2" data-maintain="" />
								<s:hidden name="importiCapitoloEntrataGestione0.diCuiAccertatoAnno3" data-maintain="" />
								...
								<tr>
									...
									<td class="text-right">
										...
										<s:hidden name="importiCapitoloEntrataGestione0.stanziamento" data-maintain="" />
									</td>
									<td class="text-right">
										...
										<s:hidden name="importiCapitoloEntrataGestione1.stanziamento" data-maintain="" />
									</td>
									<td class="text-right">
										...
										<s:hidden name="importiCapitoloEntrataGestione2.stanziamento" data-maintain="" />
									</td>
								</tr>
								<tr>
									<th>Residuo</th>
									<td class="text-right">
										...
										<s:hidden name="importiCapitoloEntrataGestione0.stanziamentoResiduo" data-maintain="" />
									</td>
									<td class="text-right">
										<label for="residuo1" class="nascosto">inserisci importo</label>
										<s:hidden id="residuo1" name="importiCapitoloEntrataGestione1.stanziamentoResiduo" data-maintain="" />
										&nbsp;
									</td>
									<td class="text-right">
										<label for="residuo2" class="nascosto">inserisci importo</label>
										<s:hidden id="residuo2" name="importiCapitoloEntrataGestione2.stanziamentoResiduo" data-maintain="" />
										&nbsp;
									</td>
								</tr>
								...
								<tr>
									...
									<td class="text-right">
										...
										<s:hidden name="importiCapitoloEntrataGestione0.stanziamentoCassa" data-maintain="" />
									</td>
									<td class="text-right">
										<label for="cassa1" class="nascosto">inserisci importo</label>
										<s:hidden id="cassa1" name="importiCapitoloEntrataGestione1.stanziamentoCassa" data-maintain="" />
										&nbsp;
									</td>
									<td class="text-right">
										<label for="cassa2" class="nascosto">inserisci importo</label>
										<s:hidden id="cassa2" name="importiCapitoloEntrataGestione2.stanziamentoCassa" data-maintain="" />
										&nbsp;
									</td>
								</tr>
							</table>
							...
							<p>
								...
								<s:a action="annullaInserisciCapEntrataGestione" cssClass="btn btn-secondary">annulla</s:a>
