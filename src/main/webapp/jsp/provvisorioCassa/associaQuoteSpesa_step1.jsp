...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form id="formAssociaDocumentoProvvisorioStep1" cssClass="form-horizontal" novalidate="novalidate" action="associaQuoteSpesaAProvvisorioDiCassa_completeSpep1" method="post">
	...
	<script type="text/javascript" src="${jspath}provvisorioDiCassa/associaQuote_step1.js"></script>
