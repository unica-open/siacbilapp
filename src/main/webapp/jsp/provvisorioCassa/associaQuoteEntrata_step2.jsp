...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				...
				<s:form id="formAssociaDocumentoProvvisorioStep2" cssClass="form-horizontal" novalidate="novalidate" action="associaQuoteEntrataAProvvisorioDiCassa_completeStep2" method="post">
						...
						<div id="step2" class="step-pane active">
							<fieldset class="form-horizontal">
								...
								<h4>
									...
									Totale quote: <span class="NumInfo" id="spanTotaleSubdocumentiEntrata"><s:property value="totaleSubdocumentiEntrata"/></span> - 
					...
					<p class="margin-medium">
						<s:a cssClass="btn" action="associaQuoteEntrataAProvvisorioDiCassa_backToStep1" id="pulsanteRedirezioneIndietro">indietro</s:a>
						<s:if test="%{!pulsanteAggiornaNascosto}">
							<span class="pull-right">
								<button type="button" class="btn btn-primary" data-submit>aggiorna quote</button>
							</span>
				...
				<s:form id="formAssociaDocumentoProvvisorioStep2_hidden" cssClass="hide" novalidate="novalidate" action="associaQuoteEntrataAProvvisorioDiCassa_completeStep2" method="post"></s:form>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/provvisorioDiCassa/associaQuoteEntrata_step2.js"></script>
