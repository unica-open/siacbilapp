			...
			<div class="span12 ">
				...
				<div class="step-content">
					<div class="step-pane active" id="step1">
						<form method="post" action="aggiornaMassivaCapEntrataPrevisione.do" novalidate="novalidate">
							<h3>
							...
							<fieldset class="form-horizontal">
								...
								<s:if test="descrizioneEditabile">
									<div class="control-group">
										...
										<div class="controls">
											<textarea rows="5" cols="15" id="descrizioneCapitolo" name="capitoloEntrataPrevisione.descrizione" class="span10"
													required="required" maxlength="500" disabled="disabled">${capitoloEntrataPrevisione.descrizione}</textarea>
										</div>
									</div>
								</s:if>
								<s:if test="descrizioneArticoloEditabile">
									<div class="control-group">
										...
										<div class="controls">
											<textarea rows="5" cols="15" id="descrizioneArticolo" name="capitoloEntrataPrevisione.descrizioneArticolo"
												class="span10" maxlength="500" disabled="disabled">${capitoloEntrataPrevisione.descrizioneArticolo}</textarea>
										</div>
									</div>
								</s:if>
											...
											<fieldset class="form-horizontal">
												...
												<s:if test="flagRilevanteIvaEditabile">
													<div class="control-group">
														...
														<div class="controls">
															<s:checkbox id="rilevanteIva" name="capitoloEntrataPrevisione.flagRilevanteIva" disabled="true" />
														</div>
													</div>
												</s:if>
												<s:if test="flagPerMemoriaEditabile">
													<div class="control-group">
														...
														<div class="controls">
															<s:checkbox id="memoria" name="capitoloEntrataPrevisione.flagPerMemoria" disabled="true" />
														</div>
													</div>
												</s:if>
												...
												<s:if test="noteEditabile">
													<div class="control-group">
														...
														<div class="controls">
															<s:textarea id="note" name="capitoloEntrataPrevisione.note" rows="5" cols="15" disabled="true"></s:textarea>
														</div>
													</div>
												</s:if>
											</fieldset>
