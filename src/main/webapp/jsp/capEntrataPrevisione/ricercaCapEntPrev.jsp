		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					...
					<h3>Ricerca Capitolo Entrata Previsione</h3>
					<s:form method="post" action="effettuaRicercaConOperazioniCapEntrataPrevisione" novalidate="novalidate">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="numeroCapitolo" class="lbTextSmall span2 soloNumeri" 
													name="capitoloEntrataPrevisione.numeroCapitolo" maxlength="200" 
													placeholder="capitolo" value="${capitoloEntrataPrevisione.numeroCapitolo}" />
												<span class="al"> 
												...
												<input type="text" id="numeroArticolo" class="lbTextSmall span2 soloNumeri" 
														name="capitoloEntrataPrevisione.numeroArticolo" maxlength="200"
														placeholder="articolo" value="${capitoloEntrataPrevisione.numeroArticolo}" />
												<s:if test="%{gestioneUEB}">
													...
													<input type="text" id="numeroUEB" class="lbTextSmall span2 soloNumeri" maxlength="200"
															name="capitoloEntrataPrevisione.numeroUEB" placeholder="UEB"
															value="${capitoloEntrataPrevisione.numeroUEB}" />
												</s:if><s:else>
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea rows="5" cols="15" id="descrizioneCapitolo" maxlength="500"
														name="capitoloEntrataPrevisione.descrizione"
														class="span10">${capitoloEntrataPrevisione.descrizione}</textarea>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<textarea rows="5" cols="15" id="descrizioneArticolo" maxlength="500"
													name="capitoloEntrataPrevisione.descrizioneArticolo"
													class="span10">${capitoloEntrataPrevisione.descrizioneArticolo}</textarea>
											</div>
										</div>
										<div class="control-group">
									...
									<div class="accordion-inner">
										<fieldset id="fieldsetAltriDati" class="form-horizontal">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="exAnnoCapitolo" class="lbTextSmall span2" maxlength="4"
															name="capitoloEntrataPrevisione.exAnnoCapitolo"
													...
													<input type="text" id="exCapitolo" class="lbTextSmall span2" maxlength="200"
															name="capitoloEntrataPrevisione.exCapitolo" placeholder="capitolo" />
													<span class="al"> 
													...
													<input type="text" id="exArticolo" class="lbTextSmall span2" maxlength="200"
															name="capitoloEntrataPrevisione.exArticolo" placeholder="articolo" />
													<s:if test="%{gestioneUEB}">
														<span class="al"> 
														...
														<input type="text" id="exUEB" class="lbTextSmall span2" maxlength="4"
															name="capitoloEntrataPrevisione.exUEB" />
													</s:if>
												</div>
											</div>
											<div class="control-group">
											...
											<div class="control-group">
												...
												<div id="divRicorrenteEntrata" class="controls">
