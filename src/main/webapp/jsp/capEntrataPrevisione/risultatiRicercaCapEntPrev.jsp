...
<body>
					...
					<form method="post" action="#">
						...
						<div id="msgElimina" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="msgEliminaLabel" aria-hidden="true">
							...
							<div class="modal-footer">
								...
								<button class="btn btn-primary" formmethod="post" type="submit" formaction="risultatiRicercaCapEntrataPrevisioneElimina.do">si, prosegui</button>
							</div>
						</div>  
						<!-- /Modale ELIMINA -->
						...
						<div id="msgAnnulla" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="msgAnnullaLabel" aria-hidden="true">
							...
							<div class="modal-footer">
								<button class="btn" data-dismiss="modal" aria-hidden="true">no, indietro</button>
								<button class="btn btn-primary" formmethod="post" type="submit" formaction="risultatiRicercaCapEntrataPrevisioneAnnulla.do">si, prosegui</button>
							</div>
						</div>  
	  					<!-- /Modale ANNULLA -->
						<p>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/capitoloEntrataPrevisione/risultatiRicerca.js"></script>
</body>
</html>