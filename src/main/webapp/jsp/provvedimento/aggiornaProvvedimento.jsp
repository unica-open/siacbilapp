...
<body>
		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					...
					<h3>${titolo}</h3>
					<s:form action="salvaAggiornaProvvedimento" id="editProvvedimento" novalidate="novalidate">
							...
							<fieldset class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<s:hidden name="attoAmministrativo.anno" />
										<span class="al">
											<label class="radio inline" for="numero">Numero *</label>
										</span>
										<s:textfield type="text" name="attoAmministrativo.numero" id="numero" cssClass="lbTextSmall span2" required="required" maxlength="7" placeholder="Numero" disabled="true" />
										<s:hidden name="attoAmministrativo.numero" />
										<span class="al">
											<label class="radio inline" for="tipoAtto">Tipo Atto *</label>
										</span>
										<s:select list="tipiAtti" listKey="uid" listValue="descrizione" name="attoAmministrativo.tipoAtto.uid" id="tipoAtto" cssClass="lbTextSmall span3" required="required" />
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span id="SPAN_StrutturaAmministrativoContabile">
											<s:if test='%{attoAmministrativo.strutturaAmmContabile != null && attoAmministrativo.strutturaAmmContabile.descrizione != null && attoAmministrativo.strutturaAmmContabile.descrizione neq ""}'>
								...
								<div class="control-group">
									...
									<div class="controls">
										<s:checkbox id="parereRegolaritaContabile" name="attoAmministrativo.parereRegolaritaContabile" />
									</div>
								</div>
							</fieldset>
						</div>
	...
	<script type="text/javascript" src="${jspath}provvedimento/aggiorna.js"></script>
</body>
</html>
