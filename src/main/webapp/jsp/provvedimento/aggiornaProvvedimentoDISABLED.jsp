							...
							<fieldset class="form-horizontal">
								<div class="control-group">
									...
									<div class="controls">
										...
										<s:select list="tipiAtti" listKey="uid" listValue="descrizione" name="attoAmministrativo.tipoAtto.uid" id="tipoAtto" cssClass="lbTextSmall span3" required="required" disabled="true" />
									</div>
								</div>
								<div class="control-group">
