				...
				<div id="campiRicercaProv<s:property value='%{suffisso}' default='' />" class="accordion-body collapse in">
					...
					<div class="control-group">
						...
						<div class="controls">
								...
								<div class="accordion-group">
									<div class="accordion-heading">
										<a href="#struttAmm_modale<s:property value='%{suffisso}' default='' />" data-toggle="collapse" class="accordion-toggle collapsed">
											<span id="SPAN_StrutturaAmministrativoContabile<s:property value='%{suffisso}' default='' />_Modale">Seleziona la Struttura amministrativa</span>
										</a>
									</div>
									<div id="struttAmm_modale<s:property value='%{suffisso}' default='' />" class="accordion-body collapse">
										<div class="accordion-inner">
											<ul id="treeStruttAmm<s:property value='%{suffisso}' default='' />_Modale" class="ztree treeStruttAmm"></ul>
							...
							<s:hidden id="%{'HIDDEN_StrutturaAmministrativoContabileUid' + suffisso + '_Modale'}" name="modale.strutturaAmministrativoContabile.uid" />
							<s:hidden id="%{'HIDDEN_StrutturaAmministrativoContabileCodice' + suffisso + '_Modale'}" name="modale.strutturaAmministrativoContabile.codice" />
							<s:hidden id="%{'HIDDEN_StrutturaAmministrativoContabileDescrizione' + suffisso + '_Modale'}" name="modale.strutturaAmministrativoContabile.descrizione" />
						</div>
					</div>
					<div class="control-group">
