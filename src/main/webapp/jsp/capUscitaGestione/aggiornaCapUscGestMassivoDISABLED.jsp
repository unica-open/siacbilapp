			...
			<div class="span12 ">
				...
				<div class="step-content">
					<div class="step-pane active" id="step1">
						<form method="post" action="aggiornaMassivaCapUscitaGestione.do" novalidate="novalidate">
							<h3>
							...
							<fieldset class="form-horizontal">
								<div class="control-group">
									...
									<div class="controls">
										...
										<input type="text" id="numeroCapitolo" class="lbTextSmall span2" maxlength="200" disabled="disabled" value="${capitoloUscitaGestione.numeroCapitolo}" />
										<span class="al">
											<label class="radio inline" for="numeroArticolo">Articolo *</label>
										</span>
										<input type="text" id="numeroArticolo" class="lbTextSmall span2" maxlength="200" disabled="disabled" value="${capitoloUscitaGestione.numeroArticolo}" />
									</div>
								</div>
								...
								<s:if test="descrizioneEditabile">
									<div class="control-group">
										...
										<div class="controls">
											<textarea rows="5" cols="15" id="descrizioneCapitolo" name="capitoloUscitaGestione.descrizione" class="span10" disabled="disabled">${capitoloUscitaGestione.descrizione}</textarea>
										</div>
									</div>
								</s:if>
								<s:if test="descrizioneArticoloEditabile">
									<div class="control-group">
										...
										<div class="controls">
											<textarea rows="5" cols="15" id="descrizioneArticolo" name="capitoloUscitaGestione.descrizioneArticolo" class="span10" disabled="disabled">${capitoloUscitaGestione.descrizioneArticolo}</textarea>
										</div>
									</div>
								</s:if>
								...
								<s:if test="flagImpegnabileEditabile">
									<div class="control-group">
										...
										<div class="controls">
											<s:checkbox id="flagImpegnabile" name="capitoloUscitaGestione.flagImpegnabile" disabled="true" data-editabile="false" />
										</div>
									</div>
								</s:if>
							</fieldset>
											...
											<fieldset class="form-horizontal">
												...
												<s:if test="flagRilevanteIvaEditabile">
													<div class="control-group">
														...
														<div class="controls">
															<s:checkbox id="rilevanteIva" name="capitoloUscitaGestione.flagRilevanteIva" disabled="true" />
														</div>
													</div>
												</s:if>
												<s:if test="flagFunzioniDelegateRegioneEditabile">
													<div class="control-group">
														...
														<div class="controls">
															<s:checkbox id="delegate" name="capitoloUscitaGestione.funzDelegateRegione" disabled="true" />
														</div>
													</div>
												</s:if>
												...
												<s:if test="noteEditabile">
													<div class="control-group">
														...
														<div class="controls">
															<s:textarea id="note" name="capitoloUscitaGestione.note" rows="5" cols="15" disabled="true"></s:textarea>
														</div>
													</div>
												</s:if>
											</fieldset>
