...
<body>
				...
				<div class="contentPage">
					<form method="post" action="#">
						...
						<div id="msgAnnulla" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="msgAnnullaLabel" aria-hidden="true">
							...
							<div class="modal-footer">
								<button class="btn" data-dismiss="modal" aria-hidden="true">no, indietro</button>
								<button class="btn btn-primary" formmethod="post" type="submit" formaction="risultatiRicercaCapUscitaGestioneAnnulla.do">si, prosegui</button>
							</div>
						</div>  
	  					<!-- /Modale ANNULLA -->
						<p>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/capitoloUscitaGestione/risultatiRicerca.js"></script>
</body>
</html>