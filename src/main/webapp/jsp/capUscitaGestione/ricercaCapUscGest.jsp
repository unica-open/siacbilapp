		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					...
					<s:form method="post" action="effettuaRicercaConOperazioniCapUscitaGestione" novalidate="novalidate">
								...
								<div class="fieldset-body">
									<fieldset class="form-horizontal">
											...
											<div class="controls">
												...
												<s:if test="%{gestioneUEB}">
													...
													<input type="text" id="numeroUEB" class="lbTextSmall span2 soloNumeri"  maxlength="200" 
															name="capitoloUscitaGestione.numeroUEB" placeholder="UEB"
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea rows="5" cols="15" id="descrizioneCapitolo" maxlength="500"
														name="capitoloUscitaGestione.descrizione"
														class="span10">${capitoloUscitaGestione.descrizione}</textarea>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<textarea rows="5" cols="15" id="descrizioneArticolo"  maxlength="500"
													...
													class="span10">${capitoloUscitaGestione.descrizioneArticolo}</textarea>
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<s:select id="categoriaCapitolo" listKey="uid" list="listaCategoriaCapitolo" name="capitoloUscitaGestione.categoriaCapitolo.uid" cssClass="span10"
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="exAnnoCapitolo" class="lbTextSmall span2" maxlength="4"
															name="capitoloUscitaGestione.exAnnoCapitolo"
													...
													<input type="text" id="exCapitolo" class="lbTextSmall span2" maxlength="200"
															name="capitoloUscitaGestione.exCapitolo" placeholder="capitolo" />
													<span class="al"> 
													...
													<input type="text" id="exArticolo" class="lbTextSmall span2" maxlength="200"
															name="capitoloUscitaGestione.exArticolo" placeholder="articolo" />
													<s:if test="%{gestioneUEB}">
														<span class="al"> 
														...
														<input type="text" id="exUEB" class="lbTextSmall span2" maxlength="200"
															name="capitoloUscitaGestione.exUEB" />
													</s:if>
												</div>
											</div>
											<div class="control-group">
