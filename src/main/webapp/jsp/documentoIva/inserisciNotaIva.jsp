...
<%-- 	<s:if test="flagIntracomunitarioUtilizzabile">
	...
	<div class="control-group">
		...
		<div class="controls">
			<s:select list="listaTipoRegistrazioneIva" name="nota.tipoRegistrazioneIva.uid" id="nota_tipoRegistrazioneIvaSubdocumentoIva"
	...
	<div class="control-group">
		...
		<div class="controls">
			<select id="nota_tipoRegistroIva" name="tipoRegistroIvaNota" required="required" class="span6">
				<option></option>
				<s:iterator value="listaTipoRegistroIva" var="tri">
					<option value="<s:property value="%{#tri}"/>" data-tipo-esigibilita-iva="<s:property value="%{#tri.tipoEsigibilitaIva}"/>"
							<s:if test="%{#tri.equals(tipoRegistroIvaNota)}">selected</s:if>>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select id="nota_attivitaIva" name="attivitaIvaNota.uid" class="span6">
				...
				<s:iterator value="listaAttivitaIva" var="ai">
					<option value="<s:property value="%{#ai.uid}" />" data-gruppo-attivita-iva="<s:property value="%{#ai.gruppoAttivitaIva.uid}" />"
						data-flag-rilevante-irap="<s:property value="%{#ai.flagRilevanteIRAP}" />" <s:if test="%{#ai.uid == attivitaIvaNota.uid}">selected</s:if>>
	...
	<div class="control-group">
		...
		<div class="controls">
			<s:select list="listaRegistroIvaNota" name="nota.registroIva.uid" cssClass="span6" id="nota_registroIvaSubdocumentoIva"
...
<p class="margin-medium">
	...
	<button type="button" class="btn btn-primary pull-right pulsanteSalvaFormIva" id="pulsanteSalvaForm_nota">salva</button>
</p>
