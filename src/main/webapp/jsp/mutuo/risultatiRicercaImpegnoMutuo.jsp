...
<body>
		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
                  ...
                  <s:form id="formRisultatiRicercaImpegnoMutuo" cssClass="form-horizontal" >
                       <s:hidden name="mutuo.uid" />
 		         		
						<h3><span id="id_num_result" class="num_result"></span></h3>
                           <s:hidden name="idx"/>
                     
                           <table class="table tab_left table-hover dataTable" id="tabellaRisultatiRicercaImpegnoMutuo" summary="....">
                              <thead>
                                 <tr>
                                	<th scope="col"></th>
						...
						<p>
							 <s:submit value="indietro" cssClass="btn" action="ricercaMovimentoGestioneMutuo" />
	...
	<script type="text/javascript" src="/siacbilapp/js/local/mutuo/risultatiRicercaImpegnoMutuo.js"></script>
</body>
</html>