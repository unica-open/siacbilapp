      ...
      <div class="row-fluid">
         <div class="span12 ">
            ...
            <div class="contentPage">
               <s:form id="formPianoAmmortamentoMutuoTassoVariabile" cssClass="form-horizontal ignore-enter-key" novalidate="novalidate">
                  <s:hidden name="mutuo.uid" />
                  <s:hidden name="mutuo.statoMutuo" />
				  <s:hidden name="mutuo.numero" />
				  <s:hidden name ="tipoTassoStr"/>
				  
                  <h3>Piano Ammortamento Mutuo a Tasso Variabile</h3>
                  <!-- message errore -->
                        ...
                        <fieldset class="form-horizontal">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 ...
                                 <s:textfield readonly="true" type="text" id="tassoInteresseEuribor" class="lbTextSmall span2 soloNumeri forzaVirgolaDecimale decimale" readonly="true" name="mutuo.tassoInteresseEuribor" />
                                 <span class="al"> <label class="radio inline" for="tassoInteresseSpread" id="tassoInteresseSpreadLabel">Spread *</label>
                                 </span>
                                 <s:textfield readonly="true" type="text" id="tassoInteresseSpread" class="lbTextSmall span2 soloNumeri forzaVirgolaDecimale decimale" readonly="true" name="mutuo.tassoInteresseSpread" />
                              </div>
                           </div>
                           ...
                           <s:if test="not mutuo.primaRataScaduta and not mutuo.statoMutuo.annullato">
                              <s:submit value="scarica modello csv" id="scaricaModelloExcelTassoVariabile" action="pianoAmmortamentoMutuoTassoVariabile_scaricaModelloCsv" class="btn scaricaModelloCsv disableOverlay" />
                              ...
                              <s:submit id="calcolaRate" value="calcola rate" cssClass="btn" action="pianoAmmortamentoMutuoTassoVariabile_calcolaRate" />
                           </s:if>
                          ...
                          <h4>Tabella rate di mutuo tasso variabile</h4>
                  ...
                  <p class="margin-medium">
                     ...
                     <s:submit value="annulla" cssClass="btn" action="pianoAmmortamentoMutuoTassoVariabile" />
                     ...
                     <s:if test='(mutuo.pianoAmmortamentoModificabile or mutuo.importiPianoAmmortamentoModificabili) and not mutuo.elencoRate.empty'>
                        <s:submit id="salva" value="salva" cssClass="btn btn-primary pull-right salva" action="pianoAmmortamentoMutuoTassoVariabile_salva" data-stato-mutuo="D"/>
                     </s:if>
					 <s:if test='(mutuo.pianoAmmortamentoModificabile or mutuo.importiPianoAmmortamentoModificabili) and not mutuo.statoMutuo.definitivo and not mutuo.elencoRate.empty'>
                        <s:submit id="salvaPredefinitivo" value="salva (predefinitivo)" cssClass="btn pull-right salva" action="pianoAmmortamentoMutuoTassoVariabile_salva" data-stato-mutuo="P"/>
                     </s:if>

                     <s:if test='mutuo.statoMutuo.definitivo'>
                        <s:submit value="variazione tasso" cssClass="btn" action="variazioneTassoMutuo" />
                     </s:if>

                     <s:if test='mutuo.statoMutuo.predefinitivo or mutuo.statoMutuo.definitivo'>
                       <s:submit value="esporta piano ammortamento in csv" cssClass="btn scaricaPianoCsv disableOverlay" action="pianoAmmortamentoMutuoTassoVariabile_scaricaPianoCsv" />
                     </s:if>

					 <s:if test='mutuo.statoMutuo.predefinitivo or mutuo.statoMutuo.definitivo'>
                       <s:submit value="esporta piano ammortamento in excel" cssClass="btn scaricaPianoExcel disableOverlay" action="pianoAmmortamentoMutuoTassoVariabile_scaricaPianoExcel" />
                     </s:if>
               ...
               <span class="hide">
                  <s:form id="form-carica-rate-da-file" action="pianoAmmortamentoMutuoTassoVariabile_caricaRateDaFile" enctype="multipart/form-data"><s:hidden name="mutuo.uid" /></s:form>
               </span>            </div>
         </div>
      </div>
   </div>
