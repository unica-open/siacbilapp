...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form cssClass="form-horizontal" action="emissioneOrdinativiIncassoElenco_completeStep2" novalidate="novalidate" method="post">
						...
						<div id="step2" class="step-pane active">
							<fieldset class="form-horizontal">
								...
								<h4 class="step-pane">
									...
									Totale da emettere: <s:property value="totaleEntrateCollegate" /> -
									Totale entrate collegate: <s:property value="totaleElenchi" />
								</h4>
								...
								<table class="table table-hover tab_left dataTable" id="tabellaElenchi">
									...
									<tfoot>
										<tr>
											...
											<th class="tab_Right"><s:property value="totaleEntrateCollegate" /></th>
										</tr>
									</tfoot>
								</table>
								...
								<table class="table table-hover tab_left dataTable">
									<thead>
										<tr>
											...
											<td class="ReportTable tab_Right">Entrate collegate: <span class="marginLeft2" id="totaleEntrateCollegateSelezionati"></span></td>
					...
					<p class="margin-medium">
						<s:a cssClass="btn" action="emissioneOrdinativiIncassoElenco_backToStep1" >indietro</s:a>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/ordinativo/emissioneIncassoStep2Elenco.js"></script>
