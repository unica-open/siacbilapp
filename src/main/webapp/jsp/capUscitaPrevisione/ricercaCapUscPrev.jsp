		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					...
					<h3>Ricerca Capitolo Spesa Previsione</h3>
					<s:form method="post" action="effettuaRicercaConOperazioniCapUscitaPrevisione" novalidate="novalidate">
								...
								<div class="fieldset-body">
									<fieldset class="form-horizontal">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="numeroCapitolo" class="lbTextSmall span2 soloNumeri" 
													name="capitoloUscitaPrevisione.numeroCapitolo" maxlength="200" 
													placeholder="capitolo" value="${capitoloUscitaPrevisione.numeroCapitolo}" />
												<span class="al"> 
												...
												<input type="text" id="numeroArticolo" class="lbTextSmall span2 soloNumeri" 
														name="capitoloUscitaPrevisione.numeroArticolo" maxlength="200"
														placeholder="articolo" value="${capitoloUscitaPrevisione.numeroArticolo}" />
												<s:if test="%{gestioneUEB}">
													...
													<input type="text" id="numeroUEB" class="lbTextSmall span2 soloNumeri" maxlength="200"
															name="capitoloUscitaPrevisione.numeroUEB" placeholder="UEB"
															value="${capitoloUscitaPrevisione.numeroUEB}" />
												</s:if><s:else>
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea rows="5" cols="15" id="descrizioneCapitolo" name="capitoloUscitaPrevisione.descrizione" 
														class="span10" maxlength="500">${capitoloUscitaPrevisione.descrizione}</textarea>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<textarea rows="5" cols="15" id="descrizioneArticolo" maxlength="500"
													name="capitoloUscitaPrevisione.descrizioneArticolo"
													class="span10">${capitoloUscitaPrevisione.descrizioneArticolo}</textarea>
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<s:if test='%{macroaggregato.uid != 0}' >
							...
							<div class="accordion-group">
								...
								<div id="collapseOne" class="accordion-body collapse">
									<div class="accordion-inner">
										<fieldset id="fieldsetAltriDati" class="form-horizontal">
											<div class="control-group">
												<label class="control-label" for="exAnnoCapitolo">Ex Anno</label>
												<div class="controls">
													<input type="text" id="exAnnoCapitolo" class="lbTextSmall span2" maxlength="4"
															name="capitoloUscitaPrevisione.exAnnoCapitolo"
															placeholder="${annoEsercizio - 1}" />
													<span class="al"> 
														<label class="radio inline" for="exCapitolo">Ex Capitolo</label>
													</span> 
													<input type="text" id="exCapitolo" class="lbTextSmall span2" maxlength="200"
															name="capitoloUscitaPrevisione.exCapitolo" placeholder="capitolo" />
													<span class="al"> 
														<label class="radio inline" for="exArticolo">Ex Articolo</label>
													</span> 
													<input type="text" id="exArticolo" class="lbTextSmall span2" maxlength="200"
															name="capitoloUscitaPrevisione.exArticolo" placeholder="articolo" />
													<s:if test="%{gestioneUEB}">
														<span class="al"> 
															<label class="radio inline" for="exUEB">
																Ex <abbr title="Unit&agrave; Elementare Bilancio">UEB</abbr>
															</label>
														</span>
														<input type="text" id="exUEB" class="lbTextSmall span2" maxlength="200"
																name="capitoloUscitaPrevisione.exUEB" />
													</s:if>
												</div>
											</div>
											<div class="control-group">
											...
											<div class="control-group">
												...
												<div class="controls">
													<select id="memoria" name="flagPerMemoria">
														<option value=""  <s:if test='flagPerMemoria == ""' >selected</s:if>>Non si applica</option>
														<option value="S" <s:if test='flagPerMemoria == "S"'>selected</s:if>>S&iacute;</option>
														<option value="N" <s:if test='flagPerMemoria == "N"'>selected</s:if>>No</option>
													</select>
												</div>
											</div>
											<div class="control-group">
											...
											<div class="control-group">
												...
												<div id="divRicorrenteSpesa" class="controls">
										...
										<fieldset class="form-horizontal">
											<div class="control-group">
												...
												<div class="controls">
													...
													<s:textfield id="attoDiLeggeNumero" cssClass="lbTextSmall span2 soloNumeri" name="attoDiLegge.numero" maxlength="8" />
													<span class="al">
														<label class="radio inline" for="attoDiLeggeTipoAtto">Tipo</label>
													</span>
													<s:select list="listaTipoAtto" id="attoDiLeggeTipoAtto" cssClass="span3" name="attoDiLegge.tipoAtto.codice" 
															headerKey="" headerValue="" listKey="codice" listValue="%{codice + '-' + descrizione}"  />
												</div>
											</div>
