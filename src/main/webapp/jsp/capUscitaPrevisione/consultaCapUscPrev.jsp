...
<body>
					...
					<form method="get" action="">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="capitolo">
								...
								<s:include value="/jsp/capUscitaPrevisione/include/consultaCapUscPrevAltriDati.jsp" />
								<hr>
								<s:include value="/jsp/capUscitaPrevisione/include/consultaCapUscPrevStanziamenti.jsp" />
							</div>
							<%-- Vincoli --%>
							...
							<div class="tab-pane" id="gestione">
								<s:include value="/jsp/cap/include/consulta_gestione_uscita.jsp" />
							</div>
						</div>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/capitoloUscitaPrevisione/consulta.js"></script>
	<script type="text/javascript" src="/siacbilapp/js/local/capitoloUscitaPrevisione/consultaGestioneEq.js"></script>
</body>
</html>