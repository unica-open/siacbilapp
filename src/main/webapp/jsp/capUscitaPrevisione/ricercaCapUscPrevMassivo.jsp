		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					...
					<s:form method="post" action="effettuaRicercaMassivaConOperazioniCapUscitaPrevisione" novalidate="novalidate">
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea rows="5" cols="15" id="descrizioneArticolo" maxlength="500"
													name="capitoloUscitaPrevisione.descrizioneArticolo" class="span10">${capitoloUscitaPrevisione.descrizioneArticolo}</textarea>
											</div>
										</div>
