			...
			<div class="span12 ">
				...
				<div class="step-content">
					<div class="step-pane active" id="step1">
						<form method="post" action="aggiornamentoMassivoCapUscitaPrevisione.do" id="aggiornamentoCapUscitaPrevisione"
								name="formAggiornamento" novalidate="novalidate">
							<s:include value="/jsp/include/messaggi.jsp" />
							<h3>
								Capitolo
								<s:property value="capitoloUscitaPrevisione.numeroCapitolo" />
								/
								<s:property value="capitoloUscitaPrevisione.numeroArticolo" />
							</h3>
							...
							<s:hidden name="capitoloUscitaPrevisione.uid" value="%{uidDaAggiornare}" />
							...
							<fieldset class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span class="al"> <label class="radio inline"
											...
											value="${capitoloUscitaPrevisione.numeroCapitolo}" />
										<s:hidden name="capitoloUscitaPrevisione.numeroCapitolo"
											value="%{capitoloUscitaPrevisione.numeroCapitolo}" />
										<span class="al"> <label class="radio inline" for="numeroArticolo">Articolo
											...
											maxlength="200" disabled="disabled"
											value="${capitoloUscitaPrevisione.numeroArticolo}" />
										<s:hidden name="capitoloUscitaPrevisione.numeroArticolo"
											value="%{capitoloUscitaPrevisione.numeroArticolo}" />
										<%-- Anno del capitolo e uid del bilancio e del capitolo --%>
										<s:hidden value="%{capitoloUscitaPrevisione.annoCapitolo}" 
												name="capitoloUscitaPrevisione.annoCapitolo" />
									</div>
								</div>
								...
								<s:if test="descrizioneEditabile">
									<div class="control-group">
										...
										<div class="controls">
											<s:textarea id="descrizioneCapitolo" name="capitoloUscitaPrevisione.descrizione" cssClass="span10"
								...
								<s:if test="descrizioneArticoloEditabile">
									<div class="control-group">
										...
										<div class="controls">
											<s:textarea id="descrizioneArticolo" name="capitoloUscitaPrevisione.descrizioneArticolo" cssClass="span10"
										...
										<div class="accordion-inner">
											<fieldset class="form-horizontal">
												...
												<s:if test="noteEditabile">
													...
													<s:hidden name="capitoloUscitaPrevisione.note" />
												</s:else>
											</fieldset>
										</div>
									</div>
