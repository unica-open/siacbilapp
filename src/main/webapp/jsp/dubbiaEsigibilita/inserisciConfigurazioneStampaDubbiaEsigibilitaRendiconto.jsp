...
<body>
		...
		<div class="row-fluid">
			<div class="span12 ">
				<div class="contentPage">
					<s:form  method="post" action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_salvaAttributi">
						<s:include value="/jsp/include/messaggi.jsp" />
						<s:hidden name="gestioneUEB" id="HIDDEN_gestioneUEB" data-maintain="" />
						<h3>
							Configurazione FCDE Rendiconto
						...
						<fieldset class="form-horizontal"> 
							...
							<s:hidden id="fcde-tipo" value="RENDICONTO" />
							
							<div class="row span8 ml-0">
								<div class="span12">
									<h4 class="step-pane">Selezione parametri</h4>
									<div class="control-group">
										<label class="control-label">Elaborazione FCDE per l'anno</label>
										<div class="controls">
											<input class="span3" type="text" readonly value="<s:property value="%{sessionHandler.bilancio.anno}" />">
											<span class="al">
											...
											<span class="parametri-editabili <s:if test="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio != null">hidden</s:if>">
												<%-- SIAC-8681 --%>
												<s:select id="quinquennioRiferimento" list="#{'':'', 
													(sessionHandler.bilancio.anno) : (sessionHandler.bilancio.anno) + '-' + (sessionHandler.bilancio.anno-4),
													(sessionHandler.bilancio.anno - 1) : (sessionHandler.bilancio.anno - 1) + '-' + (sessionHandler.bilancio.anno-5),
									...
									<div class="control-group">
										<label class="control-label">Riscossione virtuosa</label>
										<div class="controls">
											<s:textfield cssClass="lbTextSmall hide span2 text-right soloNumeri decimale" id="accantonamentoGraduale" name="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.accantonamentoGraduale" value="100,00" />
					...
					<fieldset class="form-horizontal">
						<h4 class="step-pane">Confronto FCDE - Fondo svalutazione crediti</h4>
						<div class="control-group">
							<label class="radio inline">Crediti stralciati</label>
							<input type="text" readonly class="radio inline text-right soloNumeri span2-fcde decimale parametri-editabili-campi-report" id="creditiStralciati" 
								name="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.creditiStralciati" value="<s:property value="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.creditiStralciati" />" />
							<label class="radio inline">Crediti stralciati FCDE</label>
							<input type="text" readonly class="radio inline text-right soloNumeri span2-fcde decimale parametri-editabili-campi-report" id="creditiStralciatiFcde" 
								name="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.creditiStralciatiFcde" value="<s:property value="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.creditiStralciatiFcde" />" />
							<label class="radio inline">Accertamenti anni successivi</label>
							<input type="text" readonly class="radio inline text-right soloNumeri span2-fcde decimale parametri-editabili-campi-report" id="accertamentiAnniSuccessivi" 
								name="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.accertamentiAnniSuccessivi" value="<s:property value="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.accertamentiAnniSuccessivi" />" />
							<label class="radio inline">Accertamenti anni successivi FCDE</label>
							<input type="text" readonly class="radio inline text-right soloNumeri span2-fcde decimale parametri-editabili-campi-report" id="accertamentiAnniSuccessiviFcde" 
								name="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.accertamentiAnniSuccessiviFcde" value="<s:property value="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.accertamentiAnniSuccessiviFcde" />" />
						</div>
						<div class="control-group">
							<%-- <div class="span3"></div> --%>
							<%-- SIAC-8441 --%>
							<div class="span6-fcde rg-al">
								<span class="ml-0 radio inline">
									<button type="button" id="pulsante-calcola-campi-report" class="btn btn-secondary">Calcola Fondo svalutazione crediti</button><%-- SIAC-8449 si cambia nuovamente la label --%>
								</span>
								<span class="ml-0 radio inline">
									<button type="button" id="pulsante-modifica-campi-report" class="btn btn-secondary">Modifica Fondo svalutazione crediti</button>
									<button type="button" id="pulsante-conferma-campi-report" class="btn btn-primary hidden">Conferma Fondo svalutazione crediti</button>
								</span>
							</div>
							<%-- SIAC-8441 --%>
							<%-- <div class="span3"></div> --%>
						...
						<%-- <div class="control-group">
							<div class="span3"></div> --%>
							<%-- SIAC-8679 --%>
							<div class="span6-fcde lf-al">
								<span class="ml-0 radio inline">
									<s:form action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_estraiFoglioDiCalcoloCreditiStralciati" method="post">
										<button type="submit" class="btn btn-primary" id="eseguiStampaCreditiStralciati" 
											<s:if test="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.creditiStralciati == null 
												&& accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.creditiStralciatiFcde == null">disabled</s:if>
										>Estrai foglio crediti stralciati</button>
									</s:form>
								</span>
								<span class="ml-0 radio inline">
									<s:form action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_estraiFoglioDiCalcoloAccertamentiAnniSuccessivi" method="post">
										<button type="submit" class="btn btn-primary" id="eseguiStampaAccertamentiAnniSuccessivi"
											<s:if test="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.accertamentiAnniSuccessivi == null
												&& accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.accertamentiAnniSuccessiviFcde == null">disabled</s:if>
										>Estrai foglio accertamenti anni successivi</button>
									</s:form>
								</span>
							</div>
							<%-- <div class="span3"></div> --%>
					...
					<s:if test="accantonamentoFondiDubbiaEsigibilitaAttributiBilancio != null">
						...
						<div>
							...
							<div class="dataTable-scroll-x">
								<table id="riepilogoCapitoliGiaAssociati" class="table table-hover ">
									<thead>
										...
										<tr role="row">
											...
											<th scope="col" width="7%"  role="columnheader" class="sorting_disabled text-center">totali</th>
											<th scope="col" width="7%"  role="columnheader" class="sorting_disabled text-center">rapporti</th>
											<th scope="col" width="5%" colspan="1" role="columnheader" class="sorting_disabled text-center">%</th>
									...
									<s:if test="listaAccantonamentoFondiDubbiaEsigibilitaRendiconto.empty">
										<tbody>
											<tr>
										...
										<s:iterator value="listaAccantonamentoFondiDubbiaEsigibilitaRendiconto" status="status">
											<tbody class="capitolo bc-titolo-<s:property value="capitolo.titoloEntrata.codice"/>"
												...
												<tr class="incassi" role="row">
													<td scope="col" id="info-td" width="6%" rowspan="3">
													...
													<td scope="col" width="6%" class="text-right v-middle">Incassi c/ residui</td>
													<td scope="col" width="7%" class="v-middle"><input readonly data-peso="0.10" data-original="<siac:plainstringproperty value="numeratore4Originale" />" class="importo modificabile soloNumeri w-95 text-right <s:if test="numeratore4ModificaUtente">modificato</s:if> numeratore4" type="text" value="<s:property value="numeratore4"/>"></td>
													<td scope="col" width="7%" class="v-middle"><input readonly data-peso="0.10" data-original="<siac:plainstringproperty value="numeratore3Originale" />" class="importo modificabile soloNumeri w-95 text-right <s:if test="numeratore3ModificaUtente">modificato</s:if> numeratore3" type="text" value="<s:property value="numeratore3"/>"></td>
													<td scope="col" width="7%" class="v-middle"><input readonly data-peso="0.10" data-original="<siac:plainstringproperty value="numeratore2Originale" />" class="importo modificabile soloNumeri w-95 text-right <s:if test="numeratore2ModificaUtente">modificato</s:if> numeratore2 riscossioneVirtuosa" type="text" value="<s:property value="numeratore2"/>"></td>
													<td scope="col" width="7%" class="v-middle"><input readonly data-peso="0.35" data-original="<siac:plainstringproperty value="numeratore1Originale" />" class="importo modificabile soloNumeri w-95 text-right <s:if test="numeratore1ModificaUtente">modificato</s:if> numeratore1 riscossioneVirtuosa" type="text" value="<s:property value="numeratore1"/>"></td>
													<td scope="col" width="7%" class="v-middle"><input readonly data-peso="0.35" data-original="<siac:plainstringproperty value="numeratoreOriginale"  />" class="importo modificabile soloNumeri w-95 text-right <s:if test="numeratoreModificaUtente" >modificato</s:if> numeratore riscossioneVirtuosa"  type="text" value="<s:property value="numeratore"/>"></td>
													<td scope="col" width="33%" colspan="6" ></td>
													<td scope="col" width="12%" class="v-middle"></td>
													<td scope="col" width="5%"></td>
												</tr>
												
												<tr class="accertamenti" role="row">
													<td scope="col" width="6%"  class="text-right v-middle">Residui iniziali</td>
													<td scope="col" width="7%"  class="v-middle"><input readonly data-peso="0.10" data-original="<siac:plainstringproperty value="denominatore4Originale" />" class="importo modificabile soloNumeri w-95 text-right <s:if test="denominatore4ModificaUtente">modificato</s:if> denominatore4" type="text" value="<s:property value="denominatore4"/>"></td>
													<td scope="col" width="7%"  class="v-middle"><input readonly data-peso="0.10" data-original="<siac:plainstringproperty value="denominatore3Originale" />" class="importo modificabile soloNumeri w-95 text-right <s:if test="denominatore3ModificaUtente">modificato</s:if> denominatore3" type="text" value="<s:property value="denominatore3"/>"></td>
													<td scope="col" width="7%"  class="v-middle"><input readonly data-peso="0.10" data-original="<siac:plainstringproperty value="denominatore2Originale" />" class="importo modificabile soloNumeri w-95 text-right <s:if test="denominatore2ModificaUtente">modificato</s:if> denominatore2 riscossioneVirtuosa" type="text" value="<s:property value="denominatore2"/>"></td>
													<td scope="col" width="7%"  class="v-middle"><input readonly data-peso="0.35" data-original="<siac:plainstringproperty value="denominatore1Originale" />" class="importo modificabile soloNumeri w-95 text-right <s:if test="denominatore1ModificaUtente">modificato</s:if> denominatore1 riscossioneVirtuosa" type="text" value="<s:property value="denominatore1"/>"></td>
													<td scope="col" width="7%"  class="v-middle"><input readonly data-peso="0.35" data-original="<siac:plainstringproperty value="denominatoreOriginale"  />" class="importo modificabile soloNumeri w-95 text-right <s:if test="denominatoreModificaUtente" >modificato</s:if> denominatore riscossioneVirtuosa"  type="text" value="<s:property value="denominatore"/>"></td>
													<td scope="col" width="7%"  class="v-middle whitespace-nowrap text-right">
													...
													<td scope="col" width="7%"  class="v-middle whitespace-nowrap text-right">
														...
														<input readonly class="media-utente modificabile soloNumeri w-55 text-right <s:if test="mediaUtenteModificaUtente">modificato</s:if> decimale" data-original="<siac:plainstringproperty value="mediaUtenteOriginale" />" data-media-utente-raw="<siac:numeric value="mediaUtente" decimalPlaces="5"/>" data-decimal-places="2" type="text" value="<siac:numeric value="mediaUtente" decimalPlaces="2"/>">
													...
													<td scope="col" width="3%"  class="v-middle text-right"><span class="perc-accantonamento" data-perc-acc-raw="<siac:numeric value="percentualeAccantonamentoFCDE" decimalPlaces="5"/>"><siac:numeric value="percentualeAccantonamentoFCDE" decimalPlaces="2"/></span></td>
													<td scope="col" width="12%" class="v-middle whitespace-nowrap" data-popover data-container="body" data-placement="left" data-trigger="hover" data-title="Residuo finale" data-content="<s:property value="residuoFinaleCapitolo" />">
														<span><s:property value="%{sessionHandler.bilancio.anno}"/>:</span>
														<%-- SIAC-8393 e SAIC-8394 --%>
														<input readonly type="text" class="w-65 text-right accantonamento modificabile <s:if test="mediaUtenteModificaUtente">modificato</s:if> accFcde soloNumeri whitespace-nowrap" name="accantonamento" data-anno="0" data-importo="<s:property value="residuoFinaleCapitolo" />" value="<s:property value="accantonamento" />" />
														<input type="text" class="oldAcc hidden soloNumeri text-right" value="<s:property value="accantonamento" />" /> 
														<%-- SIAC.8560 --%>
														<input type="text" class="residuo hidden soloNumeri text-right" value="<s:property value="residuoFinaleCapitolo" />" /> 
													</td>
								...
								<div>
									<s:form action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_estraiInFoglioDiCalcolo" method="post">
					...
					<p class="margin-large">
						...
						<a class="btn btn-secondary" id="pulsanteReset" href="
							<s:url action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto" >
						...
						<a class="btn btn-secondary <s:if test="statoAccantonamentoFondiDubbiaEsigibilitaDefinitivo">hidden</s:if>"     id="pulsanteModificaStatoInDefinitivo" href="<s:url action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_modificaStatoInDefinitivo" />">passa in definitivo per Allegato C</a>
						<s:if test="isConsentitoTornaInBozza()"><a class="btn btn-secondary <s:if test="not statoAccantonamentoFondiDubbiaEsigibilitaDefinitivo">hidden</s:if>" id="pulsanteModificaStatoInBozza"      href="<s:url action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_modificaStatoInBozza" />"     >torna in bozza</a></s:if>
					</p>
					
					<s:form id="form-salvaCapitoli"                   cssClass="hide" novalidate="novalidate" method="post" action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_salvaCapitoli" />
					<s:form id="formRipristinaAccantonamento_hidden"  cssClass="hide" novalidate="novalidate" method="post" action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_ripristinaAccantonamento" />
					<s:form id="formEliminaAccantonamento_hidden"     cssClass="hide" novalidate="novalidate" method="post" action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_eliminaAccantonamento" />
					<s:form id="formModificaStatoInDefinitivo_hidden" cssClass="hide" novalidate="novalidate" method="post" action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_modificaStatoInDefinitivo" />
					<s:form id="formModificaStatoInBozza_hidden"      cssClass="hide" novalidate="novalidate" method="post" action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_modificaStatoInBozza" />
					<s:form id="formSelezionaVersione_hidden"         cssClass="hide" novalidate="novalidate" method="post" action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_selezionaVersione" />
					<s:form id="formNuovaVersione_hidden"             cssClass="hide" novalidate="novalidate" method="post" action="inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto_nuovaVersione" />
				</div>
			</div>
		</div>
	</div>
	<s:include value="/jsp/dubbiaEsigibilita/popolaDaCapitoloDubbiaEsigibilta_modale.jsp">
		<s:param name="baseActionName">inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto</s:param>
	</s:include>
	...
	<script type="text/javascript" src="/siacbilapp/js/local/dubbiaEsigibilita/inserisciConfigurazioneStampaDubbiaEsigibilitaRendiconto.js"></script>
