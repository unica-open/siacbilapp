...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 contentPage">
				<s:form id="formRiCompletaAllegatoAttoStep1" cssClass="form-horizontal" novalidate="novalidate" action="riCompletaAllegatoAtto_completeStep1" method="post">
					<s:hidden id="nomeAzioneDecentrata" value="%{nomeAzioneDecentrata}" data-maintain="" />
					<s:include value="/jsp/include/messaggi.jsp" />
					<h3>Riporta a completato Atto Contabile</h3>
					<div class="wizard">
						<ul class="steps">
	...
	<script type="text/javascript" src="/siacbilapp/js/local/allegatoAtto/riCompletaElenco_step1.js"></script>
