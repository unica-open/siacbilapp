 ...
 */
public class RicercaTipoClassificatoreKeyAdapter extends BaseKeyAdapter<RicercaTipoClassificatore> {

	@Override
	public String computeNotNullKey(RicercaTipoClassificatore o) {
