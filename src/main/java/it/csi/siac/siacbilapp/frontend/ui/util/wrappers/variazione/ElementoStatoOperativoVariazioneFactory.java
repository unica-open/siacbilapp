...
public final class ElementoStatoOperativoVariazioneFactory {
	 ...
	 * @param statoOperativoVariazioneDiBilancio the stato operativo variazione di bilancio
	 * @return single instance of ElementoStatoOperativoVariazioneFactory
	 */
	public static ElementoStatoOperativoVariazione getInstance(Map<TipologiaGestioneLivelli, String> gestioneLivelli, StatoOperativoVariazioneDiBilancio statoOperativoVariazioneDiBilancio){
		if(statoOperativoVariazioneDiBilancio == null || gestioneLivelli == null) {
		...
		ElementoStatoOperativoVariazione wrapper = new ElementoStatoOperativoVariazione(statoOperativoVariazioneDiBilancio,organoAmministrativo, organoLegislativo);
		return wrapper;
	}
	 ...
	 * @return single instance of ElementoStatoOperativoVariazioneFactory
	 */
	public static List<ElementoStatoOperativoVariazione> getInstances(Map<TipologiaGestioneLivelli, String> gestioneLivelli, List<StatoOperativoVariazioneDiBilancio> statiOperativi){
		List<ElementoStatoOperativoVariazione> listaWrapper = new ArrayList<ElementoStatoOperativoVariazione>();
		String organoAmministrativo = ottieniEtichettaByConfigurazioneEnte(gestioneLivelli, TipologiaGestioneLivelli.VARIAZ_ORGANO_AMM, ETICHETTA_ORGANO_AMM_DEFAULT);
		String organoLegislativo = ottieniEtichettaByConfigurazioneEnte(gestioneLivelli, TipologiaGestioneLivelli.VARIAZ_ORGANO_LEG, ETICHETTA_ORGANO_LEG_DEFAULT);
		for (StatoOperativoVariazioneDiBilancio st : statiOperativi) {
