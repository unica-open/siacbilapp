 ...
 *
 */
public class AzioniConsentiteWrapper {
	...
	public AzioniConsentiteWrapper() {
		super();
	 ...
	 */
	public AzioniConsentiteWrapper(String actionName, List<AzioneConsentita> listaAzioniConsentite) {
		this();
	...
	private final boolean controlloAggiornaAbilitato(String actionName, List<AzioneConsentita> listaAzioniConsentite) {
		...
		for (AzioneConsentita az: listaAzioniConsentite) {
			if(controlloAzione(actionName, az, "RelazioneAttoCapitolo", AzioneConsentitaEnum.RELAZIONE_ATTO_CAPITOLO_AGGIORNA)
					|| controlloAzione(actionName, az, ACTION_NAME_USCITA_PREVISIONE, AzioneConsentitaEnum.CAPITOLO_USCITA_PREVISIONE_AGGIORNA)
					|| controlloAzione(actionName, az, ACTION_NAME_USCITA_GESTIONE, AzioneConsentitaEnum.CAPITOLO_USCITA_GESTIONE_AGGIORNA)
					|| controlloAzione(actionName, az, ACTION_NAME_ENTRATA_PREVISIONE, AzioneConsentitaEnum.CAPITOLO_ENTRATA_PREVISIONE_AGGIORNA)
					|| controlloAzione(actionName, az, ACTION_NAME_ENTRATA_GESTIONE, AzioneConsentitaEnum.CAPITOLO_ENTRATA_GESTIONE_AGGIORNA)) {
				return true;
			}
		}
		return false;
	 ...
	 */
	private boolean controlloAzione(String actionName, AzioneConsentita azioneConsentita, String actionNameToCheck, AzioneConsentitaEnum azioniConsentiteToCheck) {
	...
	private final boolean controlloAnnullaAbilitato(String actionName, List<AzioneConsentita> listaAzioniConsentite) {
		...
		for (AzioneConsentita az: listaAzioniConsentite) {
			if(controlloAzione(actionName, az, "RelazioneAttoCapitolo", AzioneConsentitaEnum.RELAZIONE_ATTO_CAPITOLO_ANNULLA)
					|| controlloAzione(actionName, az, ACTION_NAME_USCITA_PREVISIONE, AzioneConsentitaEnum.CAPITOLO_USCITA_PREVISIONE_ANNULLA)
					|| controlloAzione(actionName, az, ACTION_NAME_USCITA_GESTIONE, AzioneConsentitaEnum.CAPITOLO_USCITA_GESTIONE_ANNULLA)
					|| controlloAzione(actionName, az, ACTION_NAME_ENTRATA_PREVISIONE, AzioneConsentitaEnum.CAPITOLO_ENTRATA_PREVISIONE_ANNULLA)
					|| controlloAzione(actionName, az, ACTION_NAME_ENTRATA_GESTIONE, AzioneConsentitaEnum.CAPITOLO_ENTRATA_GESTIONE_ANNULLA)) {
				return true;
			}
		}
		return false;
	...
	private final boolean controlloEliminaAbilitato(String actionName, List<AzioneConsentita> listaAzioniConsentite) {
		...
		for (AzioneConsentita az: listaAzioniConsentite) {
			if(controlloAzione(actionName, az, ACTION_NAME_USCITA_PREVISIONE, AzioneConsentitaEnum.CAPITOLO_USCITA_PREVISIONE_ELIMINA)
					|| controlloAzione(actionName, az, ACTION_NAME_USCITA_GESTIONE, AzioneConsentitaEnum.CAPITOLO_USCITA_GESTIONE_ELIMINA)
					|| controlloAzione(actionName, az, ACTION_NAME_ENTRATA_PREVISIONE, AzioneConsentitaEnum.CAPITOLO_ENTRATA_PREVISIONE_ELIMINA)
					|| controlloAzione(actionName, az, ACTION_NAME_ENTRATA_GESTIONE, AzioneConsentitaEnum.CAPITOLO_ENTRATA_GESTIONE_ELIMINA)) {
				return true;
			}
		}
		return false;
