...
/**
 * Classe per il caricamento <em>AJAX</em> del Programma.
 * 
...
public class ProgrammaAjaxAction extends GenericClassificatoriBilByIdPadreAjaxAction {
	...
	protected void impostaPerInjezioneInVariazione(LeggiClassificatoriBilByIdPadreResponse response) {
		injettaInVariazione(TipologiaClassificatore.PROGRAMMA, response.getClassificatoriProgramma());
	}
