...
/**
 * Model per la visualizzazione dei risultati di ricerca massiva per il Capitolo di Uscita Gestione.
 * 
 * @author Alessandro Marchino
 * @version 1.0.0 23/09/2013
 * 
 */
public class RisultatiRicercaMassivaCapitoloUscitaGestioneModel extends GenericBilancioModel {
	...
	/** Costruttore vuoto di default */
	 public RisultatiRicercaMassivaCapitoloUscitaGestioneModel() {
		super();
		setTitolo("Risultati di ricerca Capitolo Spesa Gestione (Massivo)");
	 }
