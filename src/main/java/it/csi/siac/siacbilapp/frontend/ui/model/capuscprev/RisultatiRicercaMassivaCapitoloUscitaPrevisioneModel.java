...
/**
 * Model per la visualizzazione dei risultati di ricerca massiva per il Capitolo di Uscita Previsione.
 * 
 * @author Alessandro Marchino
 * @version 1.0.0 23/09/2013
 * 
 */
public class RisultatiRicercaMassivaCapitoloUscitaPrevisioneModel extends GenericBilancioModel {
	...
	/** Costruttore vuoto di default */
	 public RisultatiRicercaMassivaCapitoloUscitaPrevisioneModel() {
		super();
		setTitolo("Risultati di ricerca Capitolo Spesa Previsione (Massivo)");
	 }
