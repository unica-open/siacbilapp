...
/**
 * Model per la visualizzazione dei risultati di ricerca massiva per il Capitolo di Entrata Previsione.
 * 
 * @author Alessandro Marchino
 * @version 1.0.0 23/09/2013
 * 
 */
public class RisultatiRicercaMassivaCapitoloEntrataPrevisioneModel extends GenericBilancioModel {
	...
	/** Costruttore vuoto di default */
	 public RisultatiRicercaMassivaCapitoloEntrataPrevisioneModel() {
		super();
		setTitolo("Risultati di ricerca Capitolo Entrata Previsione (Massivo)");
	 }
