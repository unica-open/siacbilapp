 ...
 * del servizio di Eliminazione del Capitolo di Entrata Gestione.
 * 
 * @author Alessandro Marchino
 * @version 1.0.0 15/07/2013
 *
 */
public class EliminaCapitoloEntrataGestioneModel extends GenericBilancioModel {
	...
	public EliminaCapitoloEntrataGestioneModel() {
		super();
		setTitolo("Eliminazione Capitolo Entrata Gestione");
	}
	 ...
	 * 
	 * @return l'uid del Capitolo di Entrata Gestione da eliminare
	 */
	...
	/**
	 * Imposta l'uid nel Capitolo di Entrata Gestione da eliminare.
	 * 
	...
	public void setUidDaEliminare(int uidDaEliminare) {
		...
		capitoloEntrataGestione.setUid(uidDaEliminare);
	}
	...
	/**
	 * Restituisce una Request di tipo {@link EliminaCapitoloEntrataGestione} a partire dal Model.
	 * 
	 * @return la Request creata
	 */
	public EliminaCapitoloEntrataGestione creaRequestEliminaCapitoloEntrataGestione() {
		EliminaCapitoloEntrataGestione request = creaRequest(EliminaCapitoloEntrataGestione.class);
