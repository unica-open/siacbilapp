...
import it.csi.siac.siaccecapp.frontend.ui.model.cassaeconomale.richieste.pagamento.InserisciPagamentoCassaEconomaleModel;
...
/**
 * Classe di action per l'inserimento della richiesta pagamento., azioni sui giustificativi.
 * 
...
@PutModelInSession(BaseInserisciAggiornaPagamentoCassaEconomaleAction.MODEL_SESSION_NAME_INSERIMENTO)
public class InserisciPagamentoCassaEconomaleGiustificativiAction extends BaseInserisciAggiornaPagamentoCassaEconomaleAction<InserisciPagamentoCassaEconomaleModel> {
	...
	private boolean isTipoFattura(TipoGiustificativo tipoGiustificativo) {
		List<TipoGiustificativo> listaTipoGiustificativo = sessionHandler.getParametro(BilSessionParameter.LISTA_TIPO_GIUSTIFICATIVO_PAGAMENTO);
	...
	protected AzioneConsentitaEnum[] retrieveAzioniConsentite() {
		return new AzioneConsentitaEnum[] {AzioneConsentitaEnum.CASSA_ECONOMALE_PAGAMENTO_INSERISCI, AzioneConsentitaEnum.CASSA_ECONOMALE_PAGAMENTO_ABILITA};
	}
}
