...
public class StampaCECGiornaleDiCassaAction extends GenericStampaCECAction<StampaCECGiornaleCassaModel> {
	...
	public String caricaUltimaDefinitiva() {
		...
		if(response.hasErrori()) {
			...
			log.info("caricaUltimaData", createErrorInServiceInvocationString(RicercaUltimaStampaDefinitivaGiornaleCassa.class, response));
			addErrori(response);
			return SUCCESS;
		}
	...
	public String stampaGiornaleCassa() {
		...
		if(response.hasErrori()) {
			...
			log.info(methodName, createErrorInServiceInvocationString(StampaGiornaleCassa.class, response));
			addErrori(response);
