 ...
 *
 */
public class InserisciRendicontoAnticipoSpesePerMissioneCassaEconomaleModel extends BaseInserisciAggiornaRendicontoAnticipoSpesePerMissioneCassaEconomaleModel {
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -8480637006365938416L;

	/** Costruttore vuoto di default */
	public InserisciRendicontoAnticipoSpesePerMissioneCassaEconomaleModel() {
		setTitolo("Anticipo spese per missione - Inserimento Rendiconto");
	}
	...
	public String getBaseUrl() {
		return "inserisciRendicontoAnticipoSpesePerMissioneCassaEconomale";
	}
