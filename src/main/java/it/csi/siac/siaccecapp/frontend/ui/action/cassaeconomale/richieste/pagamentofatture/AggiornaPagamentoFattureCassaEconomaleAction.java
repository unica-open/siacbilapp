...
@PutModelInSession(BaseInserisciAggiornaPagamentoFattureCassaEconomaleAction.MODEL_SESSION_NAME_AGGIORNAMENTO)
public class AggiornaPagamentoFattureCassaEconomaleAction extends BaseInserisciAggiornaPagamentoFattureCassaEconomaleAction<AggiornaPagamentoFattureCassaEconomaleModel> {
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -8956967947383143174L;
	...
	public String completeStep2() {
		...
		logServiceRequest(request);
		AggiornaRichiestaEconomaleResponse response = richiestaEconomaleService.aggiornaRichiestaEconomalePagamentoFatture(request);
		logServiceResponse(response);
