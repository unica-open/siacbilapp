...
public class RicercaRimborsoSpeseCassaEconomaleAction extends BaseRicercaRichiestaEconomaleAction<RicercaRimborsoSpeseCassaEconomaleModel> {
	...
	protected TipoRichiestaEconomale findTipoRichiestaEconomale(List<TipoRichiestaEconomale> lista) {
		return ComparatorUtils.findByCodice(lista, BilConstants.CODICE_TIPO_RICHIESTA_ECONOMALE_RIMBORSO_SPESE.getConstant());
	}
