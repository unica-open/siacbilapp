...
/**
 * Classe base di model per l'inserimento e l'aggiornamento dell'anticipo per trasferta dipendenti.
 * 
 * @author Domenico Lisi
 * @version 1.0.0 - 02/02/2015
 *
 */
public abstract class BaseInserisciAggiornaAnticipoPerTrasfertaDipendentiCassaEconomaleModel extends BaseInserisciAggiornaRichiestaEconomaleModel {
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -2458725861862028342L;
