...
/**
 * Classe base di action per l'inserimento dell'anticipo spese per trasferta.
 * 
 ...
 *
 */
public abstract class BaseInserisciAggiornaAnticipoPerTrasfertaDipendentiCassaEconomaleAction<M extends BaseInserisciAggiornaAnticipoPerTrasfertaDipendentiCassaEconomaleModel> extends BaseInserisciAggiornaRichiestaEconomaleAction<M> {
	
	/** Per la serializzazione */
	private static final long serialVersionUID = 4001090349320981284L;

	/** Nome del model dell'aggiornamento per la sessione */
	public static final String MODEL_SESSION_NAME_AGGIORNAMENTO = "AggiornaAnticipoPerTrasfertaDipendentiCassaEconomaleModel";
	/** Nome del model dell'inserimento per la sessione */
	public static final String MODEL_SESSION_NAME_INSERIMENTO = "InserisciAnticipoPerTrasfertaDipendentiCassaEconomaleModel";
	/** Nome del model dell'aggiornamento rendiconto per la sessione */
	public static final String MODEL_SESSION_NAME_AGGIORNAMENTO_RENDICONTO = "AggiornaRendicontoAnticipoPerTrasfertaDipendentiCassaEconomaleModel";
	/** Nome del model dell'inserimento rendiconto per la sessione */
	public static final String MODEL_SESSION_NAME_INSERIMENTO_RENDICONTO = "InserisciRendicontoAnticipoPerTrasfertaDipendentiCassaEconomaleModel";
	...
	protected BilSessionParameter getBilSessionParameterListaTipoGiustificativo() {
		return BilSessionParameter.LISTA_TIPO_GIUSTIFICATIVO_ANTICIPO;
	}
	...
	protected boolean isValidTipoRichiestaEconomale(RichiestaEconomale richiestaEconomale) {
		return richiestaEconomale != null
			...
			&& BilConstants.CODICE_TIPO_RICHIESTA_ECONOMALE_ANTICIPO_PER_TRASFERTA_DIPENDENTI.getConstant().equals(richiestaEconomale.getTipoRichiestaEconomale().getCodice());
	}
