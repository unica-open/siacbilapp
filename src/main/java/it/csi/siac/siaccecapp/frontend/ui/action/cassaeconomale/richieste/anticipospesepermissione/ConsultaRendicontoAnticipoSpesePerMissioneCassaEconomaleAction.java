...
public class ConsultaRendicontoAnticipoSpesePerMissioneCassaEconomaleAction extends GenericBilancioAction<ConsultaRendicontoAnticipoSpesePerMissioneCassaEconomaleModel> {
	...
	protected void checkCasoDUsoApplicabile() {
		...
		boolean consentito = AzioniConsentiteFactory.isConsentitoAll(azioniConsentite, AzioniConsentite.CASSA_ECONOMALE_ANTICIPO_SPESE_PER_MISSIONE_CONSULTA_RENDICONTO, AzioniConsentite.CASSA_ECONOMALE_ANTICIPO_SPESE_PER_MISSIONE_ABILITA);
		if(!consentito) {
