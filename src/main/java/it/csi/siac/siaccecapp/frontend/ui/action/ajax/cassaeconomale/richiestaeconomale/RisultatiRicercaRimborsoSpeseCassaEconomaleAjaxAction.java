...
public class RisultatiRicercaRimborsoSpeseCassaEconomaleAjaxAction extends RisultatiRicercaRichiestaEconomaleAjaxAction {
...
//		return AzioniConsentiteFactory.isConsentito(AzioniConsentite.CASSA_ECONOMALE_RIMBORSO_SPESE_RICERCA, listaAzioniConsentite);
	...
	protected String ottieniBaseActionUrl() {
		return "risultatiRicercaRimborsoSpeseCassaEconomale";
	}
