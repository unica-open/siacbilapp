...
/**
 * Classe di action per l'inserimento del pagamento.
 * 
...
public class InserisciPagamentoCassaEconomaleAction extends BaseInserisciAggiornaPagamentoCassaEconomaleAction<InserisciPagamentoCassaEconomaleModel> {
