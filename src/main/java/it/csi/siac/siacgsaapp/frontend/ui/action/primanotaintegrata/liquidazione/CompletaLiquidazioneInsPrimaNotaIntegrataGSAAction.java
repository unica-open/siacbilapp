...
import it.csi.siac.siacgsaapp.frontend.ui.model.primanotaintegrata.liquidazione.CompletaLiquidazioneInsPrimaNotaIntegrataGSAModel;

/**
 * Classe di action per l'inserimento della prima integrata, sezione dei movimenti dettaglio, liquidazione. Modulo GSA
 * 
 * @author Valentina
 * @version 1.1.0 - 15/10/2015
 *
 */
@Component
@Scope(WebApplicationContext.SCOPE_REQUEST)
@PutModelInSession(GestioneLiquidazioneInsPrimaNotaIntegrataBaseAction.MODEL_SESSION_NAME_COMPLETA_INS_LIQUIDAZIONE_GSA)
public class CompletaLiquidazioneInsPrimaNotaIntegrataGSAAction extends GestioneLiquidazioneInsPrimaNotaIntegrataBaseAction<CompletaLiquidazioneInsPrimaNotaIntegrataGSAModel>{
