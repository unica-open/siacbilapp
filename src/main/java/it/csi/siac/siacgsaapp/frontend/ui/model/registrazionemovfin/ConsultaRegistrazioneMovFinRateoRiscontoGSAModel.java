 ...
 */
public class ConsultaRegistrazioneMovFinRateoRiscontoGSAModel extends ConsultaRegistrazioneMovFinRateoRiscontoBaseModel{
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -3597837964160950629L;

	/** Costruttore vuoto di default */
	public ConsultaRegistrazioneMovFinRateoRiscontoGSAModel() {
		super();
