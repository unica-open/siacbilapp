 ...
 *
 */
public class ConsultaRegistrazioneMovFinDocumentoSpesaGSAModel extends ConsultaRegistrazioneMovFinDocumentoSpesaBaseModel{

	/** Per la serializzazione */
	private static final long serialVersionUID = -197452792674878680L;

	/** Costruttore vuoto di dafault */
	public ConsultaRegistrazioneMovFinDocumentoSpesaGSAModel() {
