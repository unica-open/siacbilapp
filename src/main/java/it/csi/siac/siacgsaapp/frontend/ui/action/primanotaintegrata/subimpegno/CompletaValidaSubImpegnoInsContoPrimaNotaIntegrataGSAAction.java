...
import it.csi.siac.siacgsaapp.frontend.ui.model.primanotaintegrata.subimpegno.CompletaValidaSubImpegnoInsPrimaNotaIntegrataGSAModel;
...
@PutModelInSession(GestioneSubImpegnoInsPrimaNotaIntegrataBaseAction.MODEL_SESSION_NAME_COMPLETA_VALIDA_INS_SUBIMPEGNO_GSA)
public class CompletaValidaSubImpegnoInsContoPrimaNotaIntegrataGSAAction extends GestioneSubImpegnoInsContoPrimaNotaIntegrataBaseAction <CompletaValidaSubImpegnoInsPrimaNotaIntegrataGSAModel> {

	/** Per la serializzazione */
	private static final long serialVersionUID = 1043225093173526768L;
