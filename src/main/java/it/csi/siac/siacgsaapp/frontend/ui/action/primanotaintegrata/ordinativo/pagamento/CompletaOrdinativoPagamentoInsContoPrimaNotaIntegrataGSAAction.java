...
import it.csi.siac.siacgsaapp.frontend.ui.model.primanotaintegrata.ordinativo.pagamento.CompletaOrdinativoPagamentoInsPrimaNotaIntegrataGSAModel;

/**
 * Classe di action per l'inserimento della prima integrata, sezione dei movimenti dettaglio, ordinativi di pagamento. Modulo GSA
 * 
 * @author Marchino Alessandro
 * @version 1.0.0 - 14/10b/2015
 *
 */
@Component
@Scope(WebApplicationContext.SCOPE_REQUEST)
@PutModelInSession(GestioneOrdinativoPagamentoInsPrimaNotaIntegrataBaseAction.MODEL_SESSION_NAME_COMPLETA_INS_ORDINATIVO_PAGAMENTO_GSA)
public class CompletaOrdinativoPagamentoInsContoPrimaNotaIntegrataGSAAction extends GestioneOrdinativoPagamentoInsContoPrimaNotaIntegrataBaseAction <CompletaOrdinativoPagamentoInsPrimaNotaIntegrataGSAModel> {

	/** Per la serializzazione */
	private static final long serialVersionUID = 9140303234390079605L;
