...
import it.csi.siac.siacgsaapp.frontend.ui.model.primanotaintegrata.documento.spesa.CompletaValidaDocumentoSpesaInsPrimaNotaIntegrataGSAModel;

/**
 * Classe di action per la validazione della prima integrata per il subdocumento di spesa. Modulo GSA
 * 
...
@PutModelInSession(InserisciPrimaNotaIntegrataDocumentoSpesaBaseAction.MODEL_COMPLETA_E_VALIDA_DOCUMENTO_SPESA_GSA)
public class CompletaValidaSubdocumentoSpesaInsPrimaNotaIntegrataGSAAction extends InserisciPrimaNotaIntegrataSubdocumentoSpesaBaseAction<CompletaValidaDocumentoSpesaInsPrimaNotaIntegrataGSAModel> {
