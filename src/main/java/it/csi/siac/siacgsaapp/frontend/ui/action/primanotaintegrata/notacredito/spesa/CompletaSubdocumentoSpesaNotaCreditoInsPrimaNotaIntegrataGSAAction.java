...
public class CompletaSubdocumentoSpesaNotaCreditoInsPrimaNotaIntegrataGSAAction extends InserisciPrimaNotaIntegrataSubdocumentoSpesaNotaCreditoBaseAction<CompletaNotaCreditoSpesaInsPrimaNotaIntegrataGSAModel> {
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -3943697573643232409L;
