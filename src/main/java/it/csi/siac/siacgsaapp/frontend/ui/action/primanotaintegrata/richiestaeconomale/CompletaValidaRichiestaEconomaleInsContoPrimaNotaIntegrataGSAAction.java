...
import it.csi.siac.siacbasegengsaapp.frontend.ui.action.primanotaintegrata.richiestaeconomale.GestioneRichiestaEconomaleInsContoPrimaNotaIntegrataBaseAction;
...
import it.csi.siac.siacgsaapp.frontend.ui.model.primanotaintegrata.richiestaeconomale.CompletaValidaRichiestaEconomaleInsPrimaNotaIntegrataGSAModel;
...
@PutModelInSession(GestioneRichiestaEconomaleInsPrimaNotaIntegrataBaseAction.MODEL_SESSION_NAME_COMPLETA_VALIDA_INS_RICHIESTA_ECONOMALE_GSA)
public class CompletaValidaRichiestaEconomaleInsContoPrimaNotaIntegrataGSAAction extends GestioneRichiestaEconomaleInsContoPrimaNotaIntegrataBaseAction <CompletaValidaRichiestaEconomaleInsPrimaNotaIntegrataGSAModel> {
