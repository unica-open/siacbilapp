...
/**
 * Model per la visualizzazione dei risultati di ricerca per il Documento Iva di Spesa.
 * 
 * @author Domenico Lisi
 * @version 1.0.0 - 20/06/2014
 * 
 */
public class RisultatiRicercaDocumentoIvaSpesaModel  extends GenericDocumentoIvaSpesaModel {
	...
	public RisultatiRicercaDocumentoIvaSpesaModel() {
		super();
		setTitolo("Risultati di ricerca documenti iva di spesa");
	}
