 ...
 *
 */
public class RicercaDocumentoIvaSpesaModel extends GenericDocumentoIvaSpesaModel {
	...
	public RicercaDocumentoIvaSpesaModel() {
		setTitolo("Ricerca Documenti iva di spesa");
	}
	...
	/**
	 * Crea una request per il servizio di {@link RicercaSinteticaSubdocumentoIvaSpesa}.
	 * 
	 * @return la request creata
	 */
	public RicercaSinteticaSubdocumentoIvaSpesa creaRequestRicercaSinteticaSubdocumentoIva() {
		RicercaSinteticaSubdocumentoIvaSpesa request = creaRequest(RicercaSinteticaSubdocumentoIvaSpesa.class);
		
		request.setSubdocumentoIvaSpesa(creaSubdocumentoIvaSpesaPerRicerca());
		
		// Popolo i dati esterni
	 ...
	 */
	private SubdocumentoIvaSpesa creaSubdocumentoIvaSpesaPerRicerca() {
		SubdocumentoIvaSpesa sis = getSubdocumentoIva();
		if(sis == null) {
			sis = new SubdocumentoIvaSpesa();
		}
		...
		if(getDocumento() == null) {
			...
			setDocumento(new DocumentoSpesa());
		}
		...
		// Sono facoltative ma potenziali contenitori. Li inserisco comunque
