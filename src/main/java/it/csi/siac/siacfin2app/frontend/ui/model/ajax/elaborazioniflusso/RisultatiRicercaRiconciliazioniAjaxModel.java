 ...
 *
 */
public class RisultatiRicercaRiconciliazioniAjaxModel extends PagedDataTableAjaxModel<ElementoElaborazioneRiconciliazioneDoc> {
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -4029533272809633835L;

	/** Costruttore vuoto di default */
	public RisultatiRicercaRiconciliazioniAjaxModel() {
		super();
