...
public class RisultatiRicercaCausaleSpesaAjaxAction extends PagedDataTableAjaxAction<ElementoCausale, 
	...
	@Override
	protected ElementoCausale getInstance(CausaleSpesa e) throws FrontEndBusinessException {
	...
	@Override
	protected RicercaSinteticaCausaleSpesaResponse getResponse(RicercaSinteticaCausaleSpesa request) {	
