...
public class RisultatiRicercaPreDocumentoEntrataAjaxAction extends GenericRisultatiRicercaAjaxAction<ElementoPreDocumento, 
	...
	@Override
	protected ElementoPreDocumento ottieniIstanza(PreDocumentoEntrata e) throws FrontEndBusinessException {
		return ElementoPreDocumentoFactory.getInstance(e);
	}
	
	@Override
	protected RicercaSinteticaPreDocumentoEntrataResponse ottieniResponse(RicercaSinteticaPreDocumentoEntrata req) {
	...
	private boolean isAggiornaConsentita(List<AzioneConsentita> listaAzioniConsentite, ElementoPreDocumento instance) {
		return (AzioniConsentiteFactory.isConsentito(AzioniConsentite.PREDOCUMENTO_ENTRATA_AGGIORNA, listaAzioniConsentite)
	...
	private boolean isConsultaConsentita(List<AzioneConsentita> listaAzioniConsentite) {
		return AzioniConsentiteFactory.isConsentito(AzioniConsentite.PREDOCUMENTO_ENTRATA_CONSULTA, listaAzioniConsentite);
	}
	...
	private boolean isRipetiConsentito(List<AzioneConsentita> listaAzioniConsentite) {
		return AzioniConsentiteFactory.isConsentito(AzioniConsentite.PREDOCUMENTO_ENTRATA_INSERISCI, listaAzioniConsentite);
	}
}
