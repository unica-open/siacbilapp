...
/**
 * Model per la visualizzazione dei risultati di ricerca per il Documento Iva di Entrata.
 * 
 * @author Domenico Lisi
 * @version 1.0.0 - 20/06/2014
 * 
 */
public class RisultatiRicercaDocumentoIvaEntrataModel  extends GenericDocumentoIvaEntrataModel {
	...
	public RisultatiRicercaDocumentoIvaEntrataModel() {
		super();
		setTitolo("Risultati di ricerca documenti iva di entrata");
	}
