...
import it.csi.siac.siacfin2app.frontend.ui.model.ajax.elaborazioniflusso.RisultatiRiconciliazioneDocAjaxModel;
...
public class RisultatiRiconciliazioneDocAjaxAction extends PagedDataTableAjaxAction<ElementoRiconciliazioneDoc, 
RisultatiRiconciliazioneDocAjaxModel, RiconciliazioneDoc, RicercaRiconciliazioniDoc, RicercaRiconciliazioniDocResponse> {
	...
	public RisultatiRiconciliazioneDocAjaxAction() {
		super();
		setParametroSessioneLista(BilSessionParameter.RISULTATI_RICERCA_RICONCILIAZIONE_ERRORE_PAGO_PA);
		setParametroSessioneRequest(BilSessionParameter.REQUEST_RICERCA_RICONCILIAZIONE_ERRORE_PAGO_PA);
	}
	...
	@Override
	protected ElementoRiconciliazioneDoc getInstance(RiconciliazioneDoc e) throws FrontEndBusinessException {
		return new ElementoRiconciliazioneDoc(e);
	}
	...
	@Override
	protected void handleAzioniConsentite(ElementoRiconciliazioneDoc instance, boolean daRientro, boolean isAggiornaAbilitato,
