 ...
 * 
 */
public class RisultatiRicercaCapitoloUscitaGestioneAjaxModel extends GenericRisultatiRicercaAjaxModel<ElementoCapitolo> {
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -5645177165696759094L;

	/** Costruttore vuoto di default */
	public RisultatiRicercaCapitoloUscitaGestioneAjaxModel() {
		super();
		setTitolo("Risultati di ricerca Capitoli Uscita Gestione - AJAX");
	}
