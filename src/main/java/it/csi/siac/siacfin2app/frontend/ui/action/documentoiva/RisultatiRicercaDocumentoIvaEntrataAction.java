...
import it.csi.siac.siacfin2app.frontend.ui.model.documentoiva.RisultatiRicercaDocumentoIvaEntrataModel;

/**
 * Action per i risultati di ricerca del documento iva di Entrata
 */
@Component
@Scope(WebApplicationContext.SCOPE_REQUEST)
public class RisultatiRicercaDocumentoIvaEntrataAction extends GenericDocumentoIvaEntrataAction<RisultatiRicercaDocumentoIvaEntrataModel> {
