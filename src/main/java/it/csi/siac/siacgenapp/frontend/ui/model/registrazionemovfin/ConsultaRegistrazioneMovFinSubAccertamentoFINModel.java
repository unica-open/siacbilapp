 ...
 *
 */
public class ConsultaRegistrazioneMovFinSubAccertamentoFINModel extends ConsultaRegistrazioneMovFinSubAccertamentoBaseModel{
	
	/** Per la serializzazione */
	private static final long serialVersionUID = 9183052827395172841L;

	/** Costruttore vuoto di dafault */
	public ConsultaRegistrazioneMovFinSubAccertamentoFINModel() {
