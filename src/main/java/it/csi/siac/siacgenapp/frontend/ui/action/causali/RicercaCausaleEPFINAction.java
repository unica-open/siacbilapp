...
import it.csi.siac.siacgenapp.frontend.ui.model.causali.RicercaCausaleEPFINModel;
...
public class RicercaCausaleEPFINAction extends RicercaCausaleEPBaseAction<RicercaCausaleEPFINModel> {
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -4238524892696272820L;
	...
	protected BilSessionParameter getBilSessionParameterRequest() {
		return BilSessionParameter.REQUEST_RICERCA_CAUSALE_GEN;
	}

	@Override
	protected BilSessionParameter getBilSessionParameterRisultati() {
		return BilSessionParameter.RISULTATI_RICERCA_CAUSALE_GEN;
	}
