 ...
 *
 */
public class ConsultaRegistrazioneMovFinLiquidazioneFINModel extends ConsultaRegistrazioneMovFinLiquidazioneBaseModel{
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -6731629619495081477L;

	/** Costruttore vuoto di dafault */
	public ConsultaRegistrazioneMovFinLiquidazioneFINModel() {
