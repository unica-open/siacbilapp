...
/**
 * Classe di model per la consultazione della modifica del movimento di gestione di spesa. Modulo GEN
 * 
 * @author Marchino Alessandro
 * @version 1.0.0 - 17/11/2015
 *
 */
public class ConsultaRegistrazioneMovFinModificaMovimentoGestioneSpesaFINModel extends ConsultaRegistrazioneMovFinModificaMovimentoGestioneSpesaBaseModel{
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -8774816568717104760L;

	/** Costruttore vuoto di dafault */
	public ConsultaRegistrazioneMovFinModificaMovimentoGestioneSpesaFINModel() {
