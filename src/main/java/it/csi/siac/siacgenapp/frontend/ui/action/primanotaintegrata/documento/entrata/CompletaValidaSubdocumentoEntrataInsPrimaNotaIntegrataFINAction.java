...
/**
 * Classe di action per la validazione della prima integrata per il subdocumento di entrata. Modulo GEN
 * 
...
public class CompletaValidaSubdocumentoEntrataInsPrimaNotaIntegrataFINAction extends InserisciPrimaNotaIntegrataSubdocumentoEntrataBaseAction<CompletaValidaDocumentoEntrataInsPrimaNotaIntegrataFINModel> {
	
	/** Per la serializzazione */
	private static final long serialVersionUID = 7619808855339495913L;
