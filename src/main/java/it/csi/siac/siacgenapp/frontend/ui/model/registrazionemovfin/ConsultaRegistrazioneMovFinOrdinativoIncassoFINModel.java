...
/**
 * Classe di model per la consultazione dell'Ordinativo di incasso. Modulo GEN
 * 
 * @author Valentina Triolo
 * @author Marchino Alessandro
 * @version 1.0.0 - 05/05/2015
 * @version 1.1.0 - 07/10/2015
 *
 */
public class ConsultaRegistrazioneMovFinOrdinativoIncassoFINModel extends ConsultaRegistrazioneMovFinOrdinativoIncassoBaseModel{
	
	/** Per la serializzazione */
	private static final long serialVersionUID = -5405350937001901651L;

	/** Costruttore vuoto di dafault */
	public ConsultaRegistrazioneMovFinOrdinativoIncassoFINModel() {
