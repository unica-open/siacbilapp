...
public class RisultatiRicercaPrimaNotaLiberaINVAction extends RisultatiRicercaPrimaNotaLiberaBaseAction <RisultatiRicercaPrimaNotaLiberaINVModel> {
	...
	public String valida() {
		...
		if(response.hasErrori()) {
			...
			log.debug(methodName, createErrorInServiceInvocationString(ValidaPrimaNotaCespite.class, response));
			addErrori(response);
			return INPUT;
		}
	...
	public String rifiuta() {
		...
		if(response.hasErrori()) {
			//si sono verificati degli errori: esco.
			log.debug(methodName, createErrorInServiceInvocationString(RifiutaPrimaNotaCespite.class, response));
			addErrori(response);
			return INPUT;
		}
