 ...
 */
public class ElementoMovimentoEPRegistroA implements Serializable, ModelWrapper {
	...
	private final BigDecimal importoContoCespiteMovimento;
	private final BigDecimal importoInventariato;
	 ...
	 * @param importoContoCespiteMovimento the importo conto cespite movimento
	 * @param importoInventariato the importo inventariato
	 ...
	 * @param listaBeniCollegati the lista beni collegati
	 */
	public ElementoMovimentoEPRegistroA(MovimentoEP movimentoEP, BigDecimal importoContoCespiteMovimento,
			BigDecimal importoInventariato, Conto contoCespite, Evento eventoCespite, Boolean hasContoCespite, Boolean hasContoImposta,
			List<Cespite> listaBeniCollegati) {
		this.movimentoEP = movimentoEP;
		this.importoContoCespiteMovimento = importoContoCespiteMovimento;
		...
		this.listaBeniCollegati = listaBeniCollegati;
	}


	@Override
	public int getUid() {
		return movimentoEP.getUid();
	}
	 ...
	 */
	public BigDecimal getImportoContoCespiteMovimento() {
		return importoContoCespiteMovimento;
	}
	...
	public String getImportoFinanziario() {
		return FormatUtils.formatCurrency(getImportoContoCespiteMovimento());
	}
	...
	public String getImportoDaInventariareAlienare() {
		BigDecimal importoDaInventariare = getImportoContoCespiteMovimento().subtract(getImportoInventariato());
	...
	public String getImportoInventariatoString() {
		return FormatUtils.formatCurrency(getImportoInventariato());
	}
