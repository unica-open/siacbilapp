...
public abstract class GestioneSubImpegnoInsPrimaNotaIntegrataBaseAction<M extends GestioneSubImpegnoPrimaNotaIntegrataBaseModel>
		extends BaseInserisciAggiornaPrimaNotaIntegrataBaseAction<Impegno, ConsultaRegistrazioneMovFinSubImpegnoHelper, M> {
	...
	public String execute() throws Exception {
		...
		sessionHandler.setParametro(BilSessionParameter.SUBIMPEGNO, null);
	...
	private void getDatiDaSubImpegno(SubImpegno subImpegno){
		SubImpegno subImpegnoSessione = sessionHandler.getParametro(BilSessionParameter.SUBIMPEGNO);
		Impegno impegnoSessione = sessionHandler.getParametro(BilSessionParameter.IMPEGNO);
		if(subImpegnoSessione == null || subImpegnoSessione.getUid() != subImpegno.getUid()) {
			...
			sessionHandler.setParametro(BilSessionParameter.SUBIMPEGNO, subImpegnoSessione);
			sessionHandler.setParametro(BilSessionParameter.IMPEGNO, impegnoSessione);
		}
		...
		model.setConsultazioneHelper(new ConsultaRegistrazioneMovFinSubImpegnoHelper(impegnoSessione, subImpegnoSessione, model.isGestioneUEB()));
	}
	...
	protected void computaStringheDescrizioneDaRegistrazione(RegistrazioneMovFin registrazioneMovFin){
		...
		descrizione.append("SubImp ")
			.append(subImpegno.getAnnoImpegnoPadre())
			.append("/")
