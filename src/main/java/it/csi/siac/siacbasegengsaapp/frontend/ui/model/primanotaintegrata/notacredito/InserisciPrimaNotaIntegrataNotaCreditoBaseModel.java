...
*/
package it.csi.siac.siacbasegengsaapp.frontend.ui.model.primanotaintegrata.notacredito;
...
/**
 * Classe base di model per l'inserimento della prima nota integrata collegata alla nota di credito.
 * 
 ...
 */
public abstract class InserisciPrimaNotaIntegrataNotaCreditoBaseModel<D extends Documento<?, ?>, S extends Subdocumento<?, ?>, SI extends SubdocumentoIva<?, ?, ?>,
	...
	public InserisciPrimaNotaIntegrataNotaCreditoBaseModel() {
	 ...
	 */
	public void setDocumentoPadre(D documentoPadre) {
	...
	public RicercaSinteticaRegistrazioneMovFin creaRequestRicercaSinteticaRegistrazioneMovFin() {
		...
		//devo indicare da che evento parto per distinguere le registrazioni della cassa economale da quelle della nota standard
