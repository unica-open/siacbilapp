...
public class ElementoScritturaPrimaNotaIntegrata implements Serializable {
	...
	/** per serializzazione **/
	private static final long serialVersionUID = 5052393440124729733L;
	 ...
	 */
	public ElementoScritturaPrimaNotaIntegrata(RegistrazioneMovFin registrazioneMovFin, MovimentoDettaglio movimentoDettaglio, ContoTipoOperazione contoTipoOperazione, boolean aggiornamentoImportoManuale,  ClasseDiConciliazione classeDiConcilazione) {
		super();
	 ...
	 * @param aggiornamentoImportoManuale se l'aggiornamento dell'importo sia di tipo manuale
	 */
	public ElementoScritturaPrimaNotaIntegrata(RegistrazioneMovFin registrazioneMovFin, MovimentoDettaglio movimentoDettaglio, ContoTipoOperazione contoTipoOperazione, boolean aggiornamentoImportoManuale) {
		this(registrazioneMovFin, movimentoDettaglio, contoTipoOperazione, aggiornamentoImportoManuale, contoTipoOperazione.getClasseDiConciliazione());
	}
	 ...
	 */
	public ElementoScritturaPrimaNotaIntegrata(RegistrazioneMovFin registrazioneMovFin, MovimentoDettaglio movimentoDettaglio, ContoTipoOperazione contoTipoOperazione, boolean aggiornamentoImportoManuale, List<Conto> listaContiSelezionabiliDaClasseConciliazione) {
		super();
		this.registrazioneMovFin = registrazioneMovFin;
		this.movimentoDettaglio = movimentoDettaglio;
		this.contoTipoOperazione = contoTipoOperazione;
	 ...
	 * @return la registrazioneMovFin
	 */
	public RegistrazioneMovFin retrieveRegistrazioneMovFin() {
