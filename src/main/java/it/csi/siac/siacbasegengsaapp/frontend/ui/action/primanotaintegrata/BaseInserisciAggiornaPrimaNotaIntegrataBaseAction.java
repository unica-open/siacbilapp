 ...
 * 
 */
public abstract class BaseInserisciAggiornaPrimaNotaIntegrataBaseAction <E extends Entita, H extends ConsultaRegistrazioneMovFinBaseHelper<E>, M extends BaseInserisciAggiornaPrimaNotaIntegrataBaseModel<E, H>>
		extends GenericBilancioAction<M> {

	/** Per la serializzazione */
	private static final long serialVersionUID = 3508608456954529822L;
	...
	public void prepareExecute() throws Exception {
		Object nonPulireModel = sessionHandler.getParametro(BilSessionParameter.NON_PULIRE_MODEL);
	...
	protected void ricercaDettaglioPrimaNota() throws WebServiceInvocationFailureException {
		...
		if(model.isValidazione() && model.getPrimaNota().getDataRegistrazioneLibroGiornale() == null) {
	 ...
	 */
	protected abstract BilSessionParameter getSessionParameterListaCausaleEPIntegrata();
	...
	protected void caricaListaCausaleEP(boolean mayReuseSessionData) throws WebServiceInvocationFailureException {
		...
		Integer uidUltimoTipoEvento = sessionHandler.getParametro(BilSessionParameter.ULTIMO_TIPO_EVENTO_RICERCATO);
		...
		if (!mayReuseSessionData || (isTipoEventoDiversoDaUltimo || uidUltimoTipoEvento == null || listaCausaliEp == null)) {
			...
			sessionHandler.setParametro(BilSessionParameter.ULTIMO_TIPO_EVENTO_RICERCATO, model.getTipoEvento().getUid());
