...
public abstract class BaseInserisciAggiornaContoPrimaNotaIntegrataAction <E extends Entita, H extends ConsultaRegistrazioneMovFinBaseHelper<E>, M extends BaseInserisciAggiornaPrimaNotaIntegrataBaseModel<E, H>>
		extends BaseInserisciAggiornaPrimaNotaIntegrataBaseAction<E, H, M> {
	...
	public void validateEliminaConto() {
		// SIAC-5858: non conta piu' l'avere conti collegati alla causale
