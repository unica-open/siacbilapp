...
/**
 * Classe di model per i risultati della ricerca delle prime note integrate, gestione dell'AJAX.
 * 
 * @author Elisa Chiari
 * 
...
public class RisultatiRicercaDatiFinanziariPrimaNotaIntegrataBaseAjaxModel extends GenericRisultatiRicercaAjaxModel<ElementoMovimentoConsultazionePrimaNotaIntegrata<?>> {
	 ...
	 */
	private static final long serialVersionUID = 1020559846273162203L;
